...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> '未找到：Sugar 計畫任務將在有線功能情況下運行。電子郵件歸檔服務將不運行。',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到數據庫支援。請確保您已安裝支援以下任一數據庫類型所需的驅動程序：MySQL、MS SQLServer、Oracle 或 DB2。您可能需要移除 php.ini 文件中有關擴展的注譯，或者使用正確的二進制文件重新進行編譯，具體視您的 PHP 版本而定。更多關於如何啟用數據庫支援的訊息，請參考您的 PHP 手冊。',
