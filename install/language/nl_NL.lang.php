...
$mod_strings = array(
	...
	'ERR_DB_OCI8_VERSION'				=> 'Uw Oracle versie wordt niet door Sugar ondersteund. U dient een Sugar-compatible versie te installeren. Raadpleeg aub de Compatibilitieitsmatrix in de Release Notes voor de ondersteunde Oracle versies.',
	...
	'ERR_CHECKSYS_CURL'					=> 'Niet gevonden: Sugar Scheduler wordt uitgevoerd met beperkte functionaliteit. De e-mailarchiveringsdienst zal niet werken.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databaseondersteuning werd niet gevonden. Zorg ervoor dat u de nodige stuurprogramma\'s hebt voor de volgende ondersteunde types databases: MySQL, MS SQLServer, Oracle of DB2. Mogelijk moet u de extensie in het php.ini bestand verwijderen of moet u het opnieuw samenstellen met het juiste binaire bestand, afhankelijk van uw versie van PHP. Raadpleeg uw PHP-handleiding voor meer informatie over hoe u databaseondersteuning inschakelt.',
