...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nepodarilo sa nájsť: Plánovač Sugar sa spustí s obmedzenou funkčnosťou. Služba archivácie e-mailov sa nespustí.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databázovú podporu sa nepodarilo nájsť. Overte, či máte potrebné ovládače pre jeden z nasledujúcich podporovaných typov databáz: MySQL, MS SQLServer, Oracle alebo DB2. V závislosti od verzie jazyka PHP bude možno nutné odstrániť komentáre rozšírení v súbore php.ini alebo prekompilovať so správnym binárnym súborom. Ďalšie informácie o tom, ako povoliť databázovú podporu, nájdete v príručke k jazyku PHP.',
