...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No s\'ha trobat: el Planificador de sugar funcionarà amb funcionalitat limitada. El servei d\'Arxiu de correu electrònic no funcionarà.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat la compatibilitat de bases de dades.  Assegureu-vos que teniu els controladors necessaris per a un dels següents tipus de bases de dades compatibles: MySQL, MS SQLServer, Oracle o DB2.  Potser necessitareu eliminar els comentaris de l\'extensió del fitxer php.ini o tornar a intercalar amb l\'arxiu binari correcte, depenent de la versió de PHP.  Consulteu el Manual de PHP per obtenir més informació sobre com habilitar la compatibilitat de les bases de dades.',
