...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Ei löydy: Sugar Scheduler tulee toimimaan rajoitetusti. Sähköpostin arkistointipalvelu ei tule toimimaan.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt. Ole hyvä ja varmista, että sinulla on tarvittavat ajurit jollekin seuraavista tuetuista tietokantatyypeistä: MySQL, MS SQLServer, Oracle tai DB2. Sinun täytyy ehkä poistaa kommenttimerkintä laajennuksen edestä php.ini-tiedostossa tai kääntää uudelleen oikealla binääritiedostolla riippuen PHP-versiostasi. Katsothan lisätietoa tietokantatuen käyttöönotosta PHP-oppaasta.',
