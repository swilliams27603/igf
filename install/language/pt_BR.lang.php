...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Não encontrado: o Agendador Sugar será executado com funcionalidade limitada. O serviço de arquivamento de e-mail não será executado.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte do banco de dados não foi encontrado.  Deve haver os drivers necessários para um dos seguintes tipos de banco de dados suportados: MySQL, MS SQLServer, Oracle ou DB2.  Talvez seja necessário descomentar a extensão no arquivo php. ini ou recompilar com o arquivo binário correto, dependendo da sua versão do PHP.  Consulte o manual do PHP para mais informações sobre como ativar o suporte a banco de dados.',
