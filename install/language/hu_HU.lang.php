...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Az adatbázis támogatása nem található. Bizonyosodjon meg arról, hogy rendelkezik a szükséges illesztőprogramokkal az egyik alábbi támogatott adatbázis típushoz: MySQL, MS SQLServer, Oracle vagy DB2.  A PHP verziójától függően szükség lehet a kiterjesztéshez fűzött megjegyzés eltávolítására a php.ini fájlból vagy a fájl ismételt összeállítására a megfelelő bináris fájllal. Az adatbázisok támogatásának engedélyezése ügyében tájékozódjon a PHP felhasználói kézikönyvből.',
