...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'غير موجود: سوف يعمل Sugar Scheduler بقدرات وظيفية محدودة. لن تعمل خدمة أرشفة البريد الإلكتروني.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على دعم قاعدة البيانات. الرجاء التأكد من أنك تملك برامج التشغيل اللازمة لأحد أنواع قواعد البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء ربط الامتداد في ملف php.ini أو إعادة التكوين باستخدام الملف الثنائي الصحيح، وذلك حسب إصدار PHP الخاص بك. الرجاء الرجوع إلى دليل PHP لمزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
