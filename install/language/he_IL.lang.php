...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'לא נמצא: מתזמן Sugar יפעל עם פונקציונליות מוגבלת. שירות ארכיון הדוא"ל לא יפעל.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'לא נמצאה תמיכה במסד הנתונים. נא לוודא שברשותך מנהלי ההתקנים הנחוצים עבור אחד מן הסוגים של מסדי הנתונים הנתמכים הבאים: MySQL, MS SQLServer, Oracle, או DB2. ייתכן שיהיה עליך לשנות את הסיומת בקובץ php. ini, או להדר מחדש עם הקובץ הבינארי הנכון, בהתאם לגרסת ה- PHP שברשותך. ניתן לעיין במדריך PHP לקבלת פרטים נוספים על אופן הפעלת התמיכה במסד הנתונים.',
