...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Не е открито: Автоматизираните задачи на Sugar се изпълняват с ограничена функционалност. Услугата за архивиране на писмата не е активна.',
