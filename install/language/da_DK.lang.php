...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Ikke fundet: Sugar tidsplan vil køre med begrænset funktionalitet. E-mailarkiveringstjenesten virker ikke.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Database Support blev ikke fundet. Sørg venligst for at du har de nødvendige drivere til en af de følgende understøttede databasetyper: MySQL, MS SQLServer, Oracle, eller DB2.  Det er mulgivis nødvendigt at fjerne kommentar fra udvidelsen i php.ini filen, eller genoversætte med den rigtige binære fil, afhængigt af din PHP-udgave. Se venligst din PHP-brugervejledning for yderligere oplysninger om hvordan Database Support aktiveres.',
