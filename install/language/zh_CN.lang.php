...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> '未找到：Sugar 计划任务将在有限功能情况下运行。电子邮件归档服务将不运行。',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到数据库支持。请确保您已安装支持以下任一数据库类型所需的驱动程序：MySQL、MS SQLServer、Oracle 或 DB2。您可能需要移除 php.ini 文件中有关扩展的注释，或者使用正确的二进制文件重新进行编译，具体视您的 PHP 版本而定。更多关于如何启用数据库支持的信息，请参考您的 PHP 手册。',
