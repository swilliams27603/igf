...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Bulunamadı: Sugar Planlayıcı, sınırlı işlevsellikle çalışacak. E-posta Arşivleme hizmeti çalışmayacak.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri Tabanı Desteği bulunamadı. Lütfen şu desteklenen Veri Tabanı Türlerinden bir tanesi için gerekli sürücülere sahip olduğunuzda emin olun: MySQL, MS SQLServer, Oracle veya DB2.  PHP\'nizin sürümüne bağlı olarak php.ini dosyasındaki uzantının açıklamasını silmeniz veya ikili dosyayla yeniden derlemeniz gerekebilir.  Veri Tabanı Desteğinin nasıl etkinleştirileceğiyle ilgili daha fazla bilgi için lütfen PHP Kılavuzunuza bakın.',
