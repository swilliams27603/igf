...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nu s-a găsit niciun rezultat: Sugar Scheduler va rula cu funcționalitate limitată. Serviciul de arhivare e-mail-uri nu va rula.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Nu s-a găsit serviciul de asistență al bazei de date. Vă rugăm să vă asigurați că ați instalat driver-ele necesare pentru una dintre următoarele tipuri de baze de date compatibile: MySQL, MS SQLServer, Oracle sau DB2.  Va trebui eventual să ștergeți comentariul aferent extensiei din fișierul php.ini sau să îl recompilați cu fișierul binar corect, în funcție de versiunea de PHP pe care o aveți. Vă rugăm să consultați Manualul PHP pentru mai multe informații cu privire la activarea serviciului de asistență al bazei de date.',
