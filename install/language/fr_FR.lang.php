...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Introuvable : le planificateur Sugar va fonctionner de manière limitée. Le service d\'archivage d\'emails ne va pas fonctionner.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Le support de base de données n\'a pas été trouvé. Veuillez vous assurer d\'avoir les pilotes nécessaires pour un des types de base de données pris en charge suivants : MySQL, MS SQLServer, Oracle, ou DB2. Il pourrait s\'avérer nécessaire de décommenter l\'extension dans le fichier php.ini, ou de recompiler avec le fichier binaire correct, selon votre version de PHP. Veuillez consulter votre manuel PHP pour plus d\'informations sur la manière d\'activer le support de base de données.',
