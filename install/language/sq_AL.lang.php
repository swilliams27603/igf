...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Shërbimi i bazës së të dhënave nuk u gjet. Sigurohu që të kesh drejtuesit e nevojshëm për një nga llojet e mbështetura të bazës së të dhënave më poshtë: MySQL, MS SQLServer, Oracle ose DB2.  Mund të të duhet të heqësh prapashtesën në skedarin php.ini ose të krijosh sërish skedarin binar të duhur në varësi të versionit të PHP.  Për më shumë informacione rreth mënyrës së aktivizimit të mbështetjes së bazës të të dhënave, referoju manualit PHP.',
