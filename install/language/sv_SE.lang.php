...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Hittades inte: Sugar schemaläggning kommer att köras med begränsad funktionalitet. E-post arkiveringstjänsten kommer inte att köra.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databas support hittades inte. Säkerställ att du har de nödvändiga drivrutinerna för databastyperna som stöds:  MySQL, MS SQLServer, Oracle, eller DB2. Du kanske behöver avkommentera ändelsen i php.ini filen, eller kompilera om med rätt binärfil, beroende på din PHP-manual för mer information gällande hur man aktiverar databassupport.',
