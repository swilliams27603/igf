...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_ALLOW_USER_TABS' => 'Permitir aos utilizadores ocultar tabuladores',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP'          => 'Quando esta opção for selecionada, todos os utilizadores serão capazes de enviar e-mails usando a mesma conta que o sistema usa para enviar notificações e alertas. Se a opção não for selecionada, os utilizadores podem ainda utilizar o servidor de correio de saída, se assim o configurarem nas suas definições.',
	'LBL_MAILMERGE_DESC' => 'Esta opção deverá ser selecionada apenas se tiver o Sugar Plug-in para Microsoft&reg; Word&reg;.',
	'LBL_MAILMERGE' => 'Mail Merge',
	'LBL_MIN_AUTO_REFRESH_INTERVAL' => 'Intervalo Minimo de Actualização Automática do Dashlet',
	'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Este é o valor mínimo que pode ser escolhido para a atualização automática dos dashlets. Definir como &#39;Nunca&#39; desativa completamente a atualização automática dos dashlets.',
	...
	'LBL_MODULE_NAME_SINGULAR' => 'Definição do Sistema',
	...
	'LBL_PORTAL_ON_DESC' => 'Permite que os utilizadores efetuem a gestão das informações do utilizador do portal nos registos de contactos. Os utilizadores do portal podem aceder a Ocorrências, Erros, artigos da Base de Conhecimento e outros dados através da aplicação Sugar Portal.',
	...
	'LBL_PROXY_TITLE'=>'Definições do Proxy',
	'LBL_PROXY_USERNAME'=>'Nome de Utilizador',
	'LBL_RESTORE_BUTTON_LABEL'=>'Restaurar',
	'LBL_SYSTEM_SETTINGS' => 'Definições do Sistema',
	'LBL_SKYPEOUT_ON_DESC' => 'Permite que os utilizadores cliquem nos números de telefone para efetuarem uma chamada com o SkypeOut&reg;. Os números devem estar corretamente formatados para utilizar esta funcionalidade. Ou seja, deve ser "+" "O Código do País" "O Número", tal como +1 (555) 555-1234.',
    ...
    'LBL_TWEETTOCASE_ON' => 'Habilitar a integração de Tweet&reg; com ocorrências',
    'LBL_TWEETTOCASE_TITLE' => 'Ocorrências com base em Tweet&reg;',
    'LBL_PREVIEW_SETTINGS' => 'Definições do Painel de Pré-visualização',
    'LBL_PREVIEW_EDIT' => 'Ativar edição no Painel de Pré-visualização',
    'LBL_PREVIEW_EDIT_HELP' => 'Permitir que os utilizadores editem campos no Painel de Pré-visualização',
    ...
    'LBL_DISALBE_CONVERT_LEAD' => 'Desativar a ação de converter o cliente potencial para clientes potenciais convertidos',
    'LBL_DISALBE_CONVERT_LEAD_DESC' => 'Se um cliente potencial já tiver sido convertido, a ativação desta opção irá remover a ação de conversão do cliente potencial.',
    'LBL_ENABLE_ACTION_MENU' => 'Mostrar ações dentro dos menus',
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Selecione para mostrar as ações da DetailView e subpainel dentro de um menu pendente. Se não estiver selecionado, as ações serão apresentadas como botões separados. Esta definição aplica-se a módulos em modo legado.',
    'LBL_LOCK_SUBPANELS_DESC' => 'Esta definição aplica-se aos módulos em modo legado.',
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Quando selecionados, todos os subpainéis na vista de registo são comprimidos por predefinição para melhorar o desempenho. Os utilizadores que pretendam ver dados do subpainel terão de expandi-lo sempre que acederem ao registo. Nota: esta definição não se aplica a módulos Legado.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Esta definição também é usada para o número de resultados de pesquisa que surgem na página de pesquisas globais.',
    ...
    'COLLAPSE_SUBPANELS' => 'Comprimir todos os subpainéis e desativar função de fixação',
    ...
    'LBL_LOGGER'=>'Definições de Logger',
	'LBL_LOGGER_FILENAME'=>'Nome do Ficheiro de Registo',
    ...
    'LBL_LEAD_CONV_OPTION' => 'Opções de Conversão do Cliente Potencial',
    'LEAD_CONV_OPT_HELP' => "<b>Mover</b> - Move todas as atividades do Cliente Potencial para o Contacto criado durante a conversão.<br><br><b>Não Fazer Nada</b> - Não faz nada com as atividades do Cliente Potencial durante a conversão. As atividades permanecem relacionadas apenas com o Cliente Potencial.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Impede que os nomes de equipas privadas herdem os campos de nome do utilizador',
	...
	'vCAL_HELP' => 'Utilize esta definição para determinar o número de meses em antecedência à actual data em que a informação Livre/Ocupado para chamadas telefónicas e reuniões é publicada.<BR>Para desactivar a publicação Livre/Ocupado, introduza "0". O mínimo é 1 mês, o máximo são 12 meses.',
    ...
    'PDF_NEW_HEADER_LOGO_INFO' => 'O formato do ficheiro pode ser .jpg ou .png. (Apenas .jpg para EZPDF)<BR>O tamanho recomendado é 867x60 px.',
    ...
    'PDF_SMALL_HEADER_LOGO' => 'Imagem Actual',
    'PDF_SMALL_HEADER_LOGO_INFO' => 'Esta imagem aparece no Cabeçalho das páginas de documentos em PDF.',

    'PDF_NEW_SMALL_HEADER_LOGO' => 'Selecionar Nova Imagem',
    'PDF_NEW_SMALL_HEADER_LOGO_INFO' => 'Selecione uma imagem para substituir a imagem atual. O formato do ficheiro pode ser .jpg ou .png. (Apenas .jpg para EZPDF.) O tamanho recomendado é 212x40 px.',
    ...
    'K_TITLE_MAGNIFICATION_INFO' => 'A ampliação do título respeita o tamanho principal do tipo de letra.',

    'K_SMALL_RATIO' => 'Factor do Tipo de Letra Pequeno',
    'K_SMALL_RATIO_INFO' => 'Factor de redução para tipo de letra pequeno.',
    ...
    'LBL_FONTMANAGER_BUTTON' => 'Gestor de Tipo de Letra do PDF',
    'LBL_FONTMANAGER_TITLE' => 'Gestor de Tipo de Letra do PDF',
    ...
    'LBL_FONT_LIST_STYLE_INFO' => 'Estilo do tipo de letra',
    'LBL_FONT_LIST_ENC' => 'Codificação',
    'LBL_FONT_LIST_EMBEDDED' => 'Embutido',
    'LBL_FONT_LIST_EMBEDDED_INFO' => 'Verificar para incorporar o tipo de letra no ficheiro PDF',
...
"More help : www.tcpdf.org",
    'LBL_FONT_LIST_FILESIZE' => 'Tamanho do Tipo de Letra (KB)',
    'LBL_ADD_FONT' => 'Adicionar um tipo de letra',
    'LBL_BACK' => 'Voltar',
    'LBL_REMOVE' => 'rem',
    'LBL_JS_CONFIRM_DELETE_FONT' => 'Tem a certeza de que pretende eliminar este tipo de letra?',

    'LBL_ADDFONT_TITLE' => 'Adicionar um Tipo de Letra do PDF',
    'LBL_PDF_PATCH' => 'Patch',
    'LBL_PDF_PATCH_INFO' => 'Modificação personalizada da codificação. Escrever uma matriz PHP. <br>Exemplo :<br>ISO-8859-1 não contém o símbolo do euro. Para adicioná-lo na posição 164, escreva "array(164=>\\\'Euro\\\')".',
    'LBL_PDF_ENCODING_TABLE' => 'Tabela de Codificação',
    'LBL_PDF_ENCODING_TABLE_INFO' => 'Nome da tabela de codificação.<br>Esta opção é ignorada para TrueType Unicode, Unicode OpenType e tipos de letra simbólicos.<br>A codificação define a associação entre um código (de 0 a 255) e um carácter contido no tipo de letra.<br>Os primeiros 128 são fixos e correspondem ao ASCII.',
    'LBL_PDF_FONT_FILE' => 'Ficheiro do Tipo de Letra',
...
,
    ...
    'LBL_ADDFONTRESULT_TITLE' => 'Resultado do processo de adição do tipo de letra',
    'LBL_STATUS_FONT_SUCCESS' => 'SUCESSO: O tipo de letra foi adicionado ao SugarCRM.',
    'LBL_STATUS_FONT_ERROR' => 'ERRO: O tipo de letra não foi adicionado. Consulte o registo abaixo.',
    'LBL_FONT_MOVE_DEFFILE' => 'Ficheiro de definição do tipo de letra movido para: ',
...
// Font manager
    ...
    'ERR_FONT_UNKNOW_TYPE' => 'ERRO: Tipo de letra desconhecido:',
    'ERR_DELETE_CORE_FILE' => 'ERRO: Não é possível eliminar um tipo de letra principal.',
    'ERR_NO_FONT_PATH' => 'ERRO: Nenhum caminho do tipo de letra disponível!',
    'ERR_NO_CUSTOM_FONT_PATH' => 'ERRO: Nenhum caminho de tipo de letra personalizado disponível!',
    ...
    'ERR_FONT_ALREADY_EXIST' => 'ERRO : Este tipo de letra já existe. Retroceder...',
    'ERR_PDF_NO_UPLOAD' => 'Erro durante o carregamento do tipo de letra ou ficheiro métrico.',

// Wizard
    'LBL_WIZARD_TITLE' => 'Assistente de Administração',
    'LBL_WIZARD_WELCOME_TAB' => 'Bem-vindo',
    'LBL_WIZARD_WELCOME_TITLE' => 'Bem-vindo ao Sugar!',
    'LBL_WIZARD_WELCOME' => 'Clique em <b>Seguinte</b> para personalizar, localizar e configurar agora o Sugar. Se pretende configurar o Sugar mais tarde, clique em <b>Ignorar</b>.',
