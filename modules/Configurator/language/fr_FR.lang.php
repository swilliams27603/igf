...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_PORTAL_TITLE' => 'Portail Client',
    ...
    'LBL_TWEETTOCASE_ON' => 'Activer l’intégration Tweet® vers ticket',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Lorsqu&#39;ils sont sélectionnés, tous les sous-panels dans la vue de l&#39;enregistrement vont se réduire par défaut pour améliorer les performances. Les utilisateurs qui souhaitent afficher les données des sous-panels doivent développer le sous-panel à chaque fois qu&#39;ils accèdent à l&#39;enregistrement. Remarque : ce paramètre ne s&#39;applique pas aux anciens modules.',
    'LIST_ENTRIES_PER_LISTVIEW'=>'Nombre maximum d’éléments affichés par page dans les vues liste',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Ce paramètre est également utilisé pour le nombre de résultats de recherche qui s&#39;affiche sur la page de recherche globale.',
	...
	'LBL_WIRELESS_LIST_ENTRIES' => 'Nombre maximum d’éléments affichés par page dans les vues liste',
    ...
    'COLLAPSE_SUBPANELS' => 'Réduire tous les sous-panels et désactiver la fonction des notes',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Se déplacer</b> - Déplace toutes les activités de Lead vers Contact créé lors de la conversion. <br><br><b>Ne rien faire</b> - Ne fait rien avec les activités de Lead lors de la conversion. Les activités restent liées au Lead seulement.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Empêcher les noms privés des équipes d&#39;hériter des champs de noms utilisateurs',
...
"More help : www.tcpdf.org",
    ...
    'LBL_REMOVE' => 'Suppr',
    'LBL_JS_CONFIRM_DELETE_FONT' => 'Êtes-vous sûr(e) de vouloir supprimer cette Police ?',

    'LBL_ADDFONT_TITLE' => 'Ajouter une Police pour les PDFs',
    'LBL_PDF_PATCH' => 'Correctif',
