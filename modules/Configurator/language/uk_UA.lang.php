...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Якщо вибрано цю опцію, усі субпанелі запису буде за умовчанням згорнуто, щоб покращити продуктивність. Щоб переглянути дані субпанелі, її потрібно розгортати щоразу, коли користувач відкриває запис. Примітка. Це налаштування не застосовується у попередніх версіях модулів.',
    ...
    'COLLAPSE_SUBPANELS' => 'Згорніть усі субпанелі та вимкніть функцію прикріплення',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Перемістити</b> — переміщення всіх дій попередніх контактів до контактів, створених під час розмови.<br><br><b>Нічого не робити</b> — нічого не робить з діями з попереднього контакту під час перетворення. Дії й надалі стосуватимуться тільки попереднього контакту.",
