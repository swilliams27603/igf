...
$mod_strings = array (
	...
	'DEFAULT_NUMBER_GROUPING_SEP'			=> '千単位の桁区切り',
...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_ALLOW_DEFAULT_SELECTION'           => 'ユーザがEメールを送信する際にこのアカウントを使用可能:',
    ...
    'LBL_PREVIEW_EDIT_HELP' => 'ユーザによるプレビューペインでのフィールド編集を許可する',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => '選択されると、レコード ビューのすべてのサブパネルはパフォーマンスを向上させるために既定で折りたたまれます。サブパネル データを表示したい場合は、必要に応じて展開してレコードにアクセスしてください。注: この設定はレガシー モジュールには当てはまりません。',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'この設定はグローバル検索ページに表示される検索結果の数にも使用されます。',
    ...
    'COLLAPSE_SUBPANELS' => 'すべてのサブパネルを閉じ、付箋機能を無効化',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>移動</b>: リードのアクティビティすべてを会話中に作成された連絡先に移動します。<br><br><b>何もしない</b>: 会話に出たリードのアクティビティについて何もしません。これらのアクティビティとひも付けられるのは、このリードのみです。",
...
// Wizard
	...
	'LBL_YAHOO_MAIL' => 'Yahoo メール' /*for 508 compliance fix*/,
