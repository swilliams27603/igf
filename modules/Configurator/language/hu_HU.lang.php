...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Ha ki van választva, a rekord-nézetben minden alpanel alapértelmezésben összecsukódik, hogy javuljon a teljesítmény. Ha a felhasználó szeretné megtekinteni az alpanel adatait, minden alkalommal ki kell nyitnia az alpanelt, amikor megnyit egy rekordot. Megjegyzés: ez a beállítás nem érvényes az örökölt modulokra.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Ez a beállítás használható a globális keresési oldalon megjelenő keresési eredmények számához is.',
    ...
    'COLLAPSE_SUBPANELS' => 'Csukjon össze minden alpanelt, és tiltsa le az üzenőcédula funkciót',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Áthelyezés</b> - Áthelyezi a vezető általi tevékenységeket az átalakítás során létrehozott kapcsolattartóba.<br><br><b>Nem csinál semmit</b> - Nem csinál semmit a vezető tevékenységeivel az átalatkítás során. A tevékenységek továbbra is csak a vezetőhöz kapcsolódnak.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Előzze meg, hogy a privát csapatnevek átörököljék a felhasználónév-mezőket',
