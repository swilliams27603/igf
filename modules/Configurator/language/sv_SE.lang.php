...
$mod_strings = array (
	...
	'DEFAULT_DECIMAL_SEP'					=> 'Decimaltecken',
...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_ENABLE_MAILMERGE' => 'Tillåt sammanfogning av mail?',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION'           => 'Låt användare använda detta konto för utgående email:',
    'LBL_ALLOW_DEFAULT_SELECTION_HELP'          => 'När detta alternativ är valt kommer alla användare att kunna skicka email från samma utgående emailkonto som används för att skicka systemmeddelanden och varningar. Om det inte är valt kan användare fortfarande använda den utgående mailservern med sin egen kontoinformation.',
	...
	'LBL_MIN_AUTO_REFRESH_INTERVAL' => 'Minsta intervall för autouppdatering av dashlet',
	'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Det här är det minsta värdet för autouppdatering av dashleten. väljer du &#39;Aldrig&#39;; inaktiveras autouppdatering helt i dashleten.',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'När den väljs minimeras alla underpaneler i datavyn för att förbättra prestanda. Användare som vill komma åt data i underpaneler kommer att behöva öppna dem varje gång de vill komma åt datan. Obs! Detta gäller inte för Legacy-moduler.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Inställningen används även för antalet resultat som visas på den globala söksidan.',
    ...
    'COLLAPSE_SUBPANELS' => 'Minimera underpaneler och stäng av sticky-funktionen',
    'MAX_DASHLETS' => 'Max antal Sugardashlets på hemsidan',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Flytta</b> - Flyttar alla Leadets aktiviteter till Kontakten som skapats under konverteringen.<br><br><b>Gör inget</b> - Ingenting händer med Leadets aktiviteter under konverteringen. Aktiviteterna fortsätter att vara relaterade till endast Leadet.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Förhindra privata lagnamn från att ärva användarnas namnfält',
...
// Wizard
    ...
    'LBL_WIZARD_SMTP_DESC' => 'Ange det mailkonto som ska användas för att skicka email, som tilldelningsnotiser och nya användarlösenord. Användare kommer att ta emot email från Sugar från det specificerade emailkontot.',
	...
	'LBL_LOGO' => 'Logotyp' /*for 508 compliance fix*/,
