...
$mod_strings = array (
	...
	'DEFAULT_NUMBER_GROUPING_SEP'			=> '1000 διαχωριστής',
...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_USE_REAL_NAMES_DESC'			=> 'Εμφανίζει τα ονοματεπώνυμα των χρηστών, αντί μόνο των Ονομάτων τους, στα πεδία ανάθεσης.',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Όταν επιλεγεί, όλοι οι υποπίνακες στην απεικόνιση καταγραφής από προεπιλογή θα συμπτύσσονται για βελτίωση της λειτουργίας. Οι χρήστες που επιθυμούν να ανατρέχουν στα δεδομένα υποπίνακα θα πρέπει να αναπτύξουν τον υποπίνακα κάθε φορά που μπαίνουν στο αρχείο. Σημείωση: η συγκεκριμένη ρύθμιση δεν εφαρμόζεται σε παλαιού τύπου μονάδες.',
    ...
    'COLLAPSE_SUBPANELS' => 'Συμπτύξτε όλους τους υποπίνακες και απενεργοποιήστε το χαρακτηριστικό ασύγχρονου',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Μετακίνηση</b> Μετακινεί όλες τις δραστηριότητες του υποψήφιου πελάτη στην επαφή που δημιουργείται κατά τη μετατροπή. <br><br><b>Καμία ενέργεια</b> - δεν κάνει τίποτα με τις δραστηριότητες του υποψήφιου πελάτη κατά τη μετατροπή. Παραμένουν μόνο οι δραστηριότητες που σχετίζονται με το προβάδισμα.",
    ...
    'PDF_OWNER_PASSWORD_INFO' => 'Εάν δεν καθορίσετε οποιοδήποτε κωδικό πρόσβασης, το έγγραφο θα ανοίξει όπως συνήθως.<br />Εάν θέσετε έναν κωδικό πρόσβασης χρηστών, το PDF πριν ανοίξει το έγγραφο θα ζητήσει τον κωδικό.<br />Ο κύριος κωδικός πρόσβασης, εάν διαφέρει από τον έναν χρήστη, μπορεί να χρησιμοποιηθεί για να πάρει την πλήρη πρόσβαση.',
...
// Wizard
	...
	'LBL_YAHOO_MAIL' => 'Ταχυδρομείο Yahoo' /*for 508 compliance fix*/,
