...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_DISALBE_CONVERT_LEAD' => 'Deaktivér "konverter emne"-muligheten for allerdee konverterte emner',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Når valgt, slås alle underpanelene i postvisningen sammen som standard for å forbedre ytelsen. Brukere som ønsker å se underpaneldata må utvide underpanelet hver gang de vil ha tilgang til posten. Merk: Denne innstillingen gjelder ikke for eldre moduler.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Denne innstillingen brukes også for antall søkeresultater som vises på siden globalt søk.',
    ...
    'COLLAPSE_SUBPANELS' => 'Slå sammen alle underpanelene og deaktiver fast-funksjonen',
    ...
    'LBL_NEXT_' => 'Neste>>',
    'LBL_REFRESH_FROM_MARK' => 'Oppdater fra merke',
    'LBL_SEARCH' => 'Søk:',
    'LBL_REG_EXP' => 'Reg Exp:',
    'LBL_IGNORE_SELF' => 'Ignore Selv:',
    'LBL_MARKING_WHERE_START_LOGGING'=>'Merk hvor loggen startes',
    'LBL_DISPLAYING_LOG'=>'Viser logg',
    'LBL_YOUR_PROCESS_ID'=>'Your process id',
    'LBL_YOUR_IP_ADDRESS'=>'IP-adressen din er',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Flytt</b> – flytter alle lead-aktivitetene til kontakten som ble opprettet under konverteringen.<br><br><b>Ikke gjør noe</b> – gjør ingenting med lead-aktivitetene under konverteringen. Aktivitetene forblir relatert kun til leaden.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Unngå private gruppenavn fra å arve brukerens navnefelt',
