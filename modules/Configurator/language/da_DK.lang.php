...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_PORTAL_ON_DESC' => 'Tillad, at brugerne administrerer oplysninger om portalbrugere i kontaktposter. Portalbrugere kan få adgang til Sager, Fejl, Videnbaseartikler og andre data via Sugar Portal-programmet.',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Når der vælges underpaneler i en post, vil visningen som standard blive slået sammen for at forbedre ydeevnen. Brugere, der ønsker at se data i underpanelerne, skal udvide underpanelet hver gang, de får adgang til en post: Denne indstilling gælder ikke i tidligere moduler.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Denne indstilling bruges også til det antal søgeresultater, der vises på den globale søgeside.',
    ...
    'COLLAPSE_SUBPANELS' => 'Slå alle underpaneler sammen og deaktivér sticky funktionen',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Flyt</b> - Flytter alle lederens aktiviteter til den kontakt, der er oprettet under konvertering. <br> <br><b>Gør ingenting</b> - Gør ingenting ved lederens aktiviteter under konvertering. Aktiviteterne forbliver relateret kun til lederen.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Forhindrer private holdnavne i at overtage brugerens navnefelter',
