...
$mod_strings = array (
	...
	'DEFAULT_CURRENCY_ISO4217'=>'Kod waluty wg ISO 4217',
...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'To jest minimalna wartość jaką można wybrać dla opcji automatycznego odświeżania dashletów. Ustawienie Nigdy powoduje całkowite wyłączenie odświeżania.',
    ...
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Wybierz, aby wyświetlić działania Widoku szczegółowego i panelu podrzędnego w menu rozwijanym. Jeśli opcja nie zostanie wybrana, działania będą wyświetlane jako osobne przyciski. To ustawienie dotyczy modułów w starszym trybie.',
    'LBL_LOCK_SUBPANELS_DESC' => 'Te ustawienia mają zastosowanie w modułach w starszym trybie.',
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Po wybraniu wszystkie panele podrzędne w widoku rekordu zostaną domyślnie zwinięte, aby poprawić wydajność. Użytkownicy, którzy chcą widzieć dane paneli podrzędnych, będą musieli rozwijać panel podrzędnych przy każdym dostępie do rekordu. Uwaga: to ustawienie nie ma zastosowania do starszych modułów.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'To ustawienie jest również używane do liczby wyników wyszukiwania wyświetlanych na stronie globalnego wyszukiwania.',
	'LIST_ENTRIES_PER_SUBPANEL'=>'Maksymalna liczba rekordów w panelu podrzędnym na stronie',
    ...
    'LOCK_HOMEPAGE' => 'Zapobiegaj dostosowaniu układu strony głównej przez użytkownika',
    'LOCK_SUBPANELS' => 'Zapobiegaj dostosowaniu układu paneli podrzędnych przez użytkownika',
    'COLLAPSE_SUBPANELS' => 'Zwiń wszystkie panele podrzędne i wyłącz funkcję przyklejania',
    ...
    'LBL_MARKING_WHERE_START_LOGGING'=>'Zaznacz, od kiedy rozpocząć zapis w logu',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Przenieś</b> — Przenosi wszystkie wydarzenia związane z namiarem do kontaktu stworzonego podczas konwersji.<br><br><b>Nic nie rób</b> — Nie ingeruje w wydarzenia związane z namiarem podczas konwersji. Wydarzenia pozostają związane wyłącznie z namiarem.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Zapobiegaj dziedziczeniu pól nazw użytkownika przez prywatne nazwy zespołów',
    ...
    'PDF_HEADER_LOGO' => 'Dla dokumentów PDF ofert',
...
,
    ...
    'LBL_STATUS_FONT_ERROR' => 'BŁĄD: Czcionka nie została dodana. Informacje znajdują się w logu.',
...
// Font manager
    ...
    'ERR_FONT_NOT_WRITABLE' => '— nie umożliwia zapisu.',
