...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Quando vengono selezionati, tutti i sotto-pannelli nella vista record vengono chiusi in modalità predefinita per migliorare le prestazioni. Gli utenti che vogliono vedere i dati del sotto-pannello dovranno espandere il sotto-pannello ogni volta che accedono al record. Nota: questa applicazione non si applica ai moduli Legacy.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Questa impostazione viene utilizzata anche per il numero di risultati di ricerca visualizzati nella pagina di ricerca globale.',
    ...
    'COLLAPSE_SUBPANELS' => 'Chiudere tutti i sotto-pannelli e disattivare la funzione adesivo',
    ...
    'LBL_ALL' => 'Tutto',
    'LBL_MARK_POINT' => 'Punto di contrassegno',
    'LBL_NEXT_' => 'Prossimo>>',
    'LBL_REFRESH_FROM_MARK' => 'Aggiorna da contrassegno',
    'LBL_SEARCH' => 'Cerca:',
    'LBL_REG_EXP' => 'Scadenza Reg:',
    'LBL_IGNORE_SELF' => 'Ignora Sé:',
    'LBL_MARKING_WHERE_START_LOGGING'=>'Contrassegno del punto dal quale iniziare il logging',
    'LBL_DISPLAYING_LOG'=>'Visualizzazione Log',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Sposta</b> - Sposta tutte le attività del Lead al Contatto creato in fase di conversione.<br><br><b>Non fare nulla</b> - Non fa nulla con le attività del Lead in fase di conversione. Le attività restano collegate unicamente al Lead.
",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Evitare che i nomi di team privati ereditino i campi del nome utente',
...
"More help : www.tcpdf.org",
    ...
    'LBL_PDF_METRIC_FILE' => 'File metrico',
...
// Password settings
    ...
    'LBL_ADDITIONAL_MARKETING_CONTENT' => 'Abilita contenuto aggiuntivo della schermata di accesso',
);
