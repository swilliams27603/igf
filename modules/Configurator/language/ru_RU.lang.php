...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_PROXY_ON_DESC'=>'Настройка авторизации и адреса прокси-сервера',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'При выборе все субпанели в режиме записи будут свернуты по умолчанию для повышения производительности. Пользователям, желающим просмотреть данные субпанелей, необходимо будет разворачивать субпанель при каждом доступе к записи. Примечание: этот параметр не применяется к модулям прежних версий.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Данный параметр также используется для результатов поиска, отображаемых на странице глобального поиска.',
    ...
    'COLLAPSE_SUBPANELS' => 'Свернуть все панели и отключить функцию прикрепления',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Переместить</b> — перемещение всех мероприятий предварительного контакта в контакт, созданный во время преобразования. <br><br><b>Ничего не делать</b> — во время преобразования с действиями ничего не происходит. Действия остаются связанными только с предварительным контактом.",
