...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_PORTAL_TITLE' => 'Клиентски потребителски портал',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Когато бъдат избрани, всички панели със свързани записи в изгледа на записа ще се свият по подразбиране, за да се подобри производителността. Потребителите, които желаят да видят данните за свързаните панели, ще трябва да разширяват свързания панел всеки път когато влязат в записа. Забележка: тази настройка не важи за стандартни модули.',
    ...
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Тази настройка се използва също и за броя на резултатите от търсенето, които се показват на страницата за глобално търсене.',
    ...
    'COLLAPSE_SUBPANELS' => 'Свиване на всички свързани панели и деактивиране на автоматичната функция',
    'MAX_DASHLETS' => 'Максимален брой панели на началната страница',
	...
	'LBL_LDAP_USER_FILTER_DESC'=>'Допълнителни параметри на филтъра, които трябва да се приложат при идентификация на потребителите, например: <em>is_sugar_user=1 or (is_sugar_user=1)(is_sales=1)</em>',
    ...
    'LBL_LDAP_SERVER_PORT_DESC'=>'Пример: <em>389 или 636 за SSL</em>',
    ...
    'LBL_NEXT_' => 'Следващ>>',
    'LBL_REFRESH_FROM_MARK' => 'Обнови след Маркировката',
    'LBL_SEARCH' => 'Търси:',
    'LBL_REG_EXP' => 'Рег.Exp:',
	...
	'LBL_LOGGER_DEFAULT_DATE_FORMAT'=>'Формат на датата по подразбиране',
	'LBL_LOGGER_LOG_LEVEL'=>'Ниво на входа',
    'LBL_LEAD_CONV_OPTION' => 'Опции за преобразуване на Потенциални клиенти',
    'LEAD_CONV_OPT_HELP' => "<b>Премести</b> - премества всички дейности на потенциалния клиент в контакта, създаден по време на преобразуването. <br><br><b>Не прави нищо</b> - не прави нищо с дейностите на потенциалния клиент по време на преобразуването. Дейностите остават свързани само с потенциалния клиент.",
    ...
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Предотврати наследяването на полетата на името на потребителя от имената на частния екип',
    ...
    'LBL_FONTMANAGER_BUTTON' => 'Мениджър на шрифта на PDF формат',
    'LBL_FONTMANAGER_TITLE' => 'Мениджър на шрифта на PDF формат',
    'LBL_FONT_BOLD' => 'Bold',
    'LBL_FONT_ITALIC' => 'Italic',
    'LBL_FONT_BOLDITALIC' => 'Bold/Italic',
    'LBL_FONT_REGULAR' => 'Обикновен',
...
BSOFR
,
    'ERR_MISSING_CIDINFO' => 'Полето CID Information не може да бъде празно.',
    'LBL_ADDFONTRESULT_TITLE' => 'Резултат от процеса на добавяне на шрифт',
...
// Font manager
    ...
    'ERR_NO_CUSTOM_FONT_PATH' => 'ГРЕШКА: Няма наличен потребителски път към шрифта!',
...
// Wizard
    ...
    'LBL_WIZARD_WELCOME' => 'Натиснете бутона <b>Продължи</b>, за да въведете регионални настройки за системата и да конфигурирате SugarCRM сега. Ако искате да конфигурирате SugarCRM по-късно, натиснете <b>Пропусни</b>.',
...
За конфигурация на допълнителни системни настройки натиснете <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
	...
	'LBL_GMAIL_LOGO' => 'Gmail лого' /*for 508 compliance fix*/,
