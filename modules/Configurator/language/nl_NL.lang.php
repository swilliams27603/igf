...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_MODULE_ID'  => 'Configureerder',
	'LBL_MODULE_TITLE'=>'Gebruikers Interface',
	'LBL_NOTIFY_FROMADDRESS' => '&#39;Van&#39; adres:',
	'LBL_NOTIFY_SUBJECT' => 'E-mail onderwerp:',
	'LBL_PORTAL_ON_DESC' => 'Gebruikers rechten geven om de gebruikersinformatie in het portaal binnen contactrecords te beheren. Portaalgebruikers hebben via de Sugar Portaal toepassing toegang tot casussen, bugs, artikelen in de kennisbasis en andere gegevens.',
	'LBL_PORTAL_ON' => 'Portal Gebruikersbeheer inschakelen',
	'LBL_PORTAL_TITLE' => 'Zelfbedieningsportaal klanten',
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Indien geselecteerd, zullen alle subpanelen in de record-weergave standaard worden samengevouwen om de prestaties te verbeteren. Gebruikers die de gegevens van de subpanelen willen weergeven, zullen telkens wanneer ze het record openen het subpaneel moeten uitvouwen. Opmerking: deze instelling is niet van toepassing op Legacy-modules.',
    'LIST_ENTRIES_PER_LISTVIEW'=>'Onderdelen lijstweergave per pagina',
    'TPL_LIST_ENTRIES_PER_LISTVIEW_HELP'=>'Aanbevolen instelling ligt lager dan {{listEntriesNum}}, voor acceptabele prestatieniveaus. Als extra velden toegevoegd worden aan de lijstweergave, moet dit aantal aan de onderzijde van de aanbevolen instellingen liggen.',
    'LBL_LIST_ENTRIES_PER_SEARCH_HELP'=>'Deze instelling wordt ook gebruikt voor het aantal zoekresultaten die worden weergegeven op de algemene zoekpagina.',
	'LIST_ENTRIES_PER_SUBPANEL'=>'Subpanel items per pagina',
    'TPL_LIST_ENTRIES_PER_SUBPANEL_HELP'=>'Aanbevolen instelling ligt lager dan {{subpanelEntriesNum}} voor acceptabele prestatieniveaus. Als extra velden toegevoegd worden aan de lijstweergave, moet dit aantal aan de onderzijde van de aanbevolen instellingen liggen.',
	'LBL_WIRELESS_LIST_ENTRIES' => 'Onderdelen lijstweergave per pagina',
	...
	'SLOW_QUERY_TIME_MSEC'=>'Tijdsdrempel langzame query (msec)',
	'STACK_TRACE_ERRORS'=>'Stacktrace fouten weergeven',
	'UPLOAD_MAX_SIZE'=>'Maximale upload grootte',
	'VERIFY_CLIENT_IP'=>'IP-adres gebruiker bevestigen',
    ...
    'COLLAPSE_SUBPANELS' => 'Alle subpanelen samenvouwen en memofunctie uitschakelen',
    ...
    'LBL_LDAP_TITLE'=>'Ondersteuning LDAP-authenticatie',
	...
	'LBL_LDAP_USER_FILTER_DESC'=>'Eventuele extra filterparameters die kunnen worden toegepast tijdens het authenticeren van gebruikers, bijv.<em>is_sugar_user=1 of (is_sugar_user=1)(is_sales=1)</em>',
    ...
    'LBL_LDAP_SERVER_PORT_DESC'=>'Voorbeeld: <em>389 or 636 voor SSL</em>',
	'LBL_LDAP_GROUP_NAME'=>'Group Name:',
	'LBL_LDAP_GROUP_NAME_DESC'=>'Voorbeeld <em>cn=sugarcrm</em>',
    'LBL_LDAP_USER_DN_DESC'=>'Voorbeeld: <em>ou=people,dc=example,dc=com</eM>',
    ...
    'LBL_SEARCH' => 'Zoeken:',
    'LBL_REG_EXP' => 'Reg verv.:',
    'LBL_IGNORE_SELF' => 'Zelf negeren:',
    'LBL_MARKING_WHERE_START_LOGGING'=>'Markeren vanaf welk punt moet worden gelogd',
    'LBL_DISPLAYING_LOG'=>'Log weergeven',
    'LBL_YOUR_PROCESS_ID'=>'Uw verwerkings-ID',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Verplaatsen</b> - Verplaatst de activiteiten van de lead naar de contactpersoon die tijdens de conversie is aangemaakt.<br><br><b>Niets doen</b> - Doet niets met de activiteiten van de lead tijdens de conversie. De activiteiten blijven alleen betrekking houden op de lead.",
	'LBL_LOGGER_MAX_LOGS'=>'Maximaal aantal logs (voor rollen)',
	'LBL_LOGGER_FILENAME_SUFFIX' =>'Aanpassen na bestandsnaam',
	'LBL_VCAL_PERIOD' => 'vCal Updates Frequentie',
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Voorkom dat privé teamnamen de velden van de gebruikersnamen overnemen',
    'LBL_IMPORT_MAX_RECORDS' => 'Import - Maximum aantal Rijen:',
    'LBL_IMPORT_MAX_RECORDS_HELP' => 'Specificeer hoeveel rijen zijn toegestaan in importbestanden. Als er meer rijen<br>in een importbestand zijn dan dit aantal wordt de gebruiker hierover ingelicht. Als geen aantal<br>is ingevoerd is een onbeperkt aantal rijen toegestaan.',
...
// Wizard
    'LBL_WIZARD_TITLE' => 'Wizard beheer',
