...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Este es el valor mínimo que se puede elegir para la actualización automática de los dashlets. Ajustar a "Never" desactiva que se actualicen automáticamente los dashlets.',
	...
	'LBL_PORTAL_ON' => 'Habilitar Administración de Usuario de Portal',
    ...
    'LBL_DISALBE_CONVERT_LEAD_DESC' => 'Si un cliente potencial se ha convertido ya, activar esta opción eliminará la acción de conversión del cliente.',
    'LBL_ENABLE_ACTION_MENU' => 'Mostrar acciones dentro de los menús',
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Seleccione para mostrar la Vista detallada y el subpanel de acciones dentro de un menú desplegable. Si no se selecciona, las acciones se mostrarán como botones independientes. Esta configuración se aplica a los módulos en modo heredado.',
    'LBL_LOCK_SUBPANELS_DESC' => 'Esta configuración se aplica a los módulos en modo heredado.',
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'Cuando se selecciona, todos los subpaneles de la vista de registros se minimizarán por defecto para mejorar el rendimiento. Los usuarios que deseen ver datos del subpanel tendrán que expandirlo cada vez que accedan al registro. Nota: este ajuste no se aplica a los módulos heredados.',
    'LIST_ENTRIES_PER_LISTVIEW'=>'Lista de vista elementos por página',
    'TPL_LIST_ENTRIES_PER_LISTVIEW_HELP'=>'La configuración recomendada está por debajo de {{listEntriesNum}} para niveles de rendimiento aceptables. Cuando se añaden campos adicionales a la vista de lista, este valor debería ser el mínimo de la configuración recomendada.',
    ...
    'TPL_LIST_ENTRIES_PER_SUBPANEL_HELP'=>'La configuración recomendada está por debajo de {{subpanelEntriesNum}} para niveles de rendimiento aceptables. Cuando se añaden campos adicionales a la vista de lista, este valor debería ser el mínimo de la configuración recomendada.',
	'LBL_WIRELESS_LIST_ENTRIES' => 'Lista de vista elementos por página',
    ...
    'QUOTES_CURRENT_LOGO'=>'Logotipo para Presupuestos',
	'SLOW_QUERY_TIME_MSEC'=>'Umbral de tiempo para consultas lentas (ms)',
	'STACK_TRACE_ERRORS'=>'Mostrar traza de la pila de errores',
	'UPLOAD_MAX_SIZE'=>'Tamaño máximo para carga de archivos',
    ...
    'COLLAPSE_SUBPANELS' => 'Minimice todos los subpaneles e inhabilite la característica adhesiva',
    ...
    'LBL_LDAP_TITLE'=>'Comptibilidad de Autenticación LDAP',
	...
	'LBL_LDAP_USER_FILTER_DESC'=>'Cualquier parámetro de filtrado adicional a aplicar a la hora de autenticar usuarios. Por ejemplo: <em>is_sugar_user=1 o (is_sugar_user=1)(is_sales=1)</em>',
    'LBL_LDAP_LOGIN_ATTRIBUTE'=>'Atributo de Inicio de Sesión:',
    'LBL_LDAP_BIND_ATTRIBUTE'=>'Atributo de Conexión (Bind):',
    'LBL_LDAP_BIND_ATTRIBUTE_DESC'=>'Para enlazar los ejemplos de usuario LDAP:[<b>AD:</b>&nbsp;userPrincipalName] [<b>openLDAP:</b>&nbsp;userPrincipalName] [<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid] ',
    'LBL_LDAP_LOGIN_ATTRIBUTE_DESC'=>'Para buscar al Usuario LDAP Ejemplos:<b>AD:[<b>AD:</b>&nbsp;userPrincipalName] [<b>openLDAP:</b>&nbsp;dn] [<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;dn] ',
    'LBL_LDAP_SERVER_HOSTNAME_DESC'=>'Ejemplo: ldap.example.com o ldaps://ldap.example.com cuando se usa SSL',
    'LBL_LDAP_SERVER_PORT_DESC'=>'Ejemplo: <em>389 o 636 cuando se usa SSL</em>',
	'LBL_LDAP_GROUP_NAME'=>'Nombre de Grupo:',
	'LBL_LDAP_GROUP_NAME_DESC'=>'Ejemplo: <em>cn=sugarcrm</em>',
    'LBL_LDAP_USER_DN_DESC'=>'Ejemplo: <em>ou=gente,dc=ejemplo,dc=com</eM>',
	...
	'SHOW_DOWNLOADS_TAB_HELP' =>'Cuando se selecciona, la pestaña de descarga aparecerá en la configuración del usuario y ofrece a los usuarios el acceso a los complementos y otros archivos de Sugar disponibles',
    ...
    'LBL_MARKING_WHERE_START_LOGGING'=>'Marcando desde dónde Iniciar el registro',
    'LBL_DISPLAYING_LOG'=>'Mostrando Registro',
    'LBL_YOUR_PROCESS_ID'=>'Su ID de proceso',
    'LBL_YOUR_IP_ADDRESS'=>'Su Dirección IP es',
    'LBL_IT_WILL_BE_IGNORED'=>' Se ignorará ',
    ...
    'LBL_LOGGER'=>'Configuración de registrador',
    ...
    'LBL_PDFMODULE_NAME' => 'Notifique la plantilla de PDF',
    ...
    'PDF_NEW_HEADER_LOGO_INFO' => 'El formato de archivo puede ser .jpg o .png. (Solo .jpg para EZPDF)<BR>El tamaño recomendado es 867x60 px.',

    'PDF_HEADER_LOGO_WIDTH' => 'Anchura de Imagen para Presupuestos',
    'PDF_HEADER_LOGO_WIDTH_INFO' => 'Cambia la escala de la imagen cargada que aparece en los Documentos PDF de Presupuestos. (Solo TCPDF)',

    'PDF_SMALL_HEADER_LOGO' => 'Imagen actual',
    'PDF_SMALL_HEADER_LOGO_INFO' => 'Esta imagen aparece en la Cabecera de las páginas de documentos PDF.',

    'PDF_NEW_SMALL_HEADER_LOGO' => 'Seleccione una Nueva Imagen',
    'PDF_NEW_SMALL_HEADER_LOGO_INFO' => 'Seleccione una imagen para sustituir a la actual. El formato de archivo puede ser .jpg o .png. (Solo .jpg para EZPDF). El tamaño recomendado es 212x40 px.',

    'PDF_SMALL_HEADER_LOGO_WIDTH' => 'Anchura de Imagen para Informes',
    'PDF_SMALL_HEADER_LOGO_WIDTH_INFO' => 'Cambia la escala de la imagen cargada que aparece en los Documentos PDF de Informes. (Solo TCPDF)',
    ...
    'PDF_HEADER_TITLE_INFO' => 'Cadena para imprimir como título en la cabecera del documento',
    ...
    'PDF_COMPRESSION_INFO' => 'Activa o desactiva la compresión de página. <br>Cuando se activa, la representación interna de cada página se comprime, llegando a niveles de ratios de compresión de aprox. 2 para el documento resultante.',

    'PDF_JPEG_QUALITY' => 'Calidad JPEG (1-100)',
    'PDF_JPEG_QUALITY_INFO' => 'Establecer la calidad de compresión JPEG por defecto (1-100)',

    'PDF_PDF_VERSION' => 'Versión PDF',
    'PDF_PDF_VERSION_INFO' => 'Establecer la versión de PDF (consultar la referencia PDF para valores válidos).',

    'PDF_PROTECTION' => 'Protección de Documento',
    'PDF_PROTECTION_INFO' => 'Establecer la protección de documento<br>- copiar: copiar texto e imágenes al portapapeles<br>- imprimir: imprimir el documento<br>- modificar: modificar el documento (excepto las anotaciones y formularios)<br>- anot.-forms.: añadir anotaciones y formularios<br>Nota: la protección ante la modificación es para gente que posee el producto Acrobat completo.',
	...
	'PDF_GD_WARNING'=>'No ha instalado la librería GD para PHP. Sin la librería GD, sólo se mostrarán los logotipos JPEG en los documentos PDF.',
    'ERR_EZPDF_DISABLE'=>'Aviso : La clase EZPDF ha sido deshabilitada en la tabla de configuración y se ha establecido como la clase para PDF. "Guarde" este formulario para establecer TCPDF como la Clase PDF y vuelva en un estado estable.',
...
"More help : www.tcpdf.org",
    ...
    'LBL_ADDFONT_TITLE' => 'Añadir una Fuente de PDF',
    ...
    'LBL_PDF_ENCODING_TABLE_INFO' => 'Nombre de la tabla de codificación.<br>Esta opción se ignora en Unicode TrueType, Unicode OpenType y fuentes con símbolos.<br>La codificación define la asociación entre un código (de 0 a 255) y un carácter contenido en la fuente.<br>Los primeros 128 son fijos y se corresponden con ASCII.',
...
// Wizard
    ...
    'LBL_WIZARD_SMTP_DESC' => 'Proporcione la cuenta de email que se utilizará para enviar emails, como las notificaciones de asignación y las contraseñas de nuevos usuarios. Los usuarios recibirán emails de Sugar, como si hubieran sido enviados desde la cuenta de email especificada.',
	'LBL_GMAIL_LOGO' => 'Logotipo de Gmail' /*for 508 compliance fix*/,
