...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => "%s %s レコード、そのためAdvanced Workflowがプロセス #%s をトリガーしました。",
    'LBL_PMSE_HISTORY_LOG_GATEWAY'  => "%s %s %s は評価され、次のタスクに送られました",
    'LBL_PMSE_HISTORY_LOG_EVENT'  => "%s イベント %s が %s",
    'LBL_PMSE_HISTORY_LOG_END_EVENT'  => "終了",
    'LBL_PMSE_HISTORY_LOG_MODIFIED'  => "変更済",
    'LBL_PMSE_HISTORY_LOG_STARTED'  => "開始済",
    'LBL_PMSE_HISTORY_LOG_PROCESSED'  => "処理済",
    'LBL_PMSE_HISTORY_LOG_ACTIVITY_SELF_SERVICE'  => "%s レコードでのアクティビティ %s をセルフサービスで利用できました",
    'LBL_PMSE_HISTORY_LOG_ACTIVITY'  => "%s レコードでの %s アクティビティ %s",
    'LBL_PMSE_HISTORY_LOG_ASSIGNED'  => "がアサインされました",
    'LBL_PMSE_HISTORY_LOG_ACTION'  => "%s アクション %s が %s レコードで処理されました",
    ...
    'LBL_PMSE_LABEL_REASSIGN' => '活動を再アサイン',
    'LBL_PMSE_LABEL_CHANGE_OWNER' => 'レコードオーナーを変更',
    ...
    'LBL_PMSE_LABEL_CURRENT_ACTIVITY' => '現在のアクティビティ',
    'LBL_PMSE_LABEL_ACTIVITY_DELEGATE_DATE' => 'アクティビティ委任データ',
    'LBL_PMSE_LABEL_ACTIVITY_START_DATE' => '開始日',
    ...
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Advanced Workflowログビューワー',
    ...
    'LBL_PMSE_SETTING_NUMBER_CYCLES' => "エラーになるまでのループ回数",
