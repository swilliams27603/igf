...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_CREATED' => "creado",
    'LBL_PMSE_HISTORY_LOG_ROUTED' => "dirigido",
    ...
    'LBL_PMSE_HISTORY_LOG_DERIVATED_CASE' => "se ha asignado el proceso #%s ",
    'LBL_PMSE_HISTORY_LOG_CURRENTLY_HAS_CASE' => "actualmente, tiene el proceso #%s ",
    ...
    'LBL_PMSE_HISTORY_LOG_NO_YET_STARTED' => '(todavía no iniciado)',
    'LBL_PMSE_HISTORY_LOG_FLOW' => 'se ha asignado para continuar la tarea',
    ...
    'LBL_PMSE_HISTORY_LOG_EVENT'  => "El %s evento %s se ha %s",
    ...
    'LBL_PMSE_HISTORY_LOG_ACTION'  => "La %s acción %s se ha procesado en el registro %s",
    'LBL_PMSE_HISTORY_LOG_ASSIGN_USER_ACTION'  => "se ha asignado al proceso #%s %s el registro %s por el %s de acción %s",
    ...
    'LBL_PMSE_LABEL_REASSIGN' => 'Reasignar actividad',
    'LBL_PMSE_LABEL_CHANGE_OWNER' => 'Cambiar propietario del registro',
    ...
    'LBL_PMSE_ALERT_REASSIGN_SUCCESS' => 'El proceso de a reasignado correctamente',

    'LBL_PMSE_LABEL_CURRENT_ACTIVITY' => 'Actividad actual',
    'LBL_PMSE_LABEL_ACTIVITY_DELEGATE_DATE' => 'Datos de delegados de actividades',
    'LBL_PMSE_LABEL_ACTIVITY_START_DATE' => 'Fecha de Inicio',
    'LBL_PMSE_LABEL_EXPECTED_TIME' => 'Tiempo esperado',
    'LBL_PMSE_LABEL_DUE_DATE' => 'Fecha Vencimiento',
    ...
    'LBL_PMSE_TITLE_REASSIGN' => 'Cambiar propietario del registro',
    'LBL_PMSE_TITLE_AD_HOC' => 'Reasignar actividad',
    'LBL_PMSE_TITLE_ACTIVITY_TO_REASSIGN' => "Reasignar actividad",
    ...
    'LBL_PA_PROCESS_ROUTE_QUESTION' => '¿Está seguro de que desea dirigir este proceso?',
    'LBL_PA_PROCESS_APPROVED_SUCCESS' => 'El proceso se ha aprobado correctamente',
    'LBL_PA_PROCESS_REJECTED_SUCCESS' => 'El proceso se ha rechazado correctamente',
    'LBL_PA_PROCESS_ROUTED_SUCCESS' => 'El proceso se ha dirigido correctamente',
