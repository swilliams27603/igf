...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_CREATED' => "sukurtas",
    'LBL_PMSE_HISTORY_LOG_ROUTED' => "nukreipta",
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => "%s a(n) %s įrašas, dėl kurio išplėstinė darbo eiga paleidžia #%s procesą",
    'LBL_PMSE_HISTORY_LOG_GATEWAY'  => "%s %s %s buvo įvertintas ir nukreiptas į kitą (-as) užduotį (-is)",
    'LBL_PMSE_HISTORY_LOG_EVENT'  => "%s įvykis %s buvo %s",
    'LBL_PMSE_HISTORY_LOG_END_EVENT'  => "Baigtas",
    'LBL_PMSE_HISTORY_LOG_MODIFIED'  => "pakeistas",
    'LBL_PMSE_HISTORY_LOG_STARTED'  => "pradėtas",
    'LBL_PMSE_HISTORY_LOG_PROCESSED'  => "apdorotas",
    'LBL_PMSE_HISTORY_LOG_ACTIVITY_SELF_SERVICE'  => "%s veikla %s įraše buvo pasiekiama savitarnoje",
    'LBL_PMSE_HISTORY_LOG_ACTIVITY'  => "%s veikla %s %s įraše",
    'LBL_PMSE_HISTORY_LOG_ASSIGNED'  => "buvo priskirta",
    'LBL_PMSE_HISTORY_LOG_ACTION'  => "%s veiksmas %s buvo apdorotas %s įraše",
    ...
    'LBL_PMSE_FORM_LABEL_TYPE' => 'Tipas',
    'LBL_PMSE_FORM_LABEL_NOTE' => 'Užrašas',

    'LBL_PMSE_BUTTON_SAVE' => 'Saugoti',
    'LBL_PMSE_BUTTON_CLOSE' => 'Užbaigti',
    'LBL_PMSE_BUTTON_CANCEL' => 'Atšaukti',
    'LBL_PMSE_BUTTON_REFRESH' => 'Atnaujinti',
    'LBL_PMSE_BUTTON_CLEAR' => 'Išvalyti',
    ...
    'LBL_PMSE_LABEL_ACTIVITY_START_DATE' => 'Pradžios data',
    'LBL_PMSE_LABEL_EXPECTED_TIME' => 'Expected Time',
    'LBL_PMSE_LABEL_DUE_DATE' => 'Atlikimo data',
    ...
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Procesas Nr. {{id}}: dabartinė būsena',
