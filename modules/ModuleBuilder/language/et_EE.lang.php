...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu vormis <b>Kiirgeneraator</b>.<br><br>Kiirgeneraator ilmub mooduli alampaneelile, kui vajutate nuppu Loo.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ja välju ning paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ning <b>Paigutus</b> vahel ja paigutuse enda sees.<br><br>Välja eemaldamiseks paigutusest lohistage väli suvandisse <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--teemast_väljas!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Märgib sõltuvat välja, mis võib või ei pruugi olla valemi väärtusest olenevalt nähtav.<br/><!--teemast_väljas!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Märgib arvutatud välja, mille väärtus määratakse valemi järgi automaatselt.'
    ,
        //this defualt will be used for edit view
        'default'	=> 'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu vaates <b>Redigeerimisvaade</b>.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ja välju ning paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ning <b>Paigutus</b> vahel ja paigutuse enda sees.<br><br>Välja eemaldamiseks paigutusest lohistage väli suvandisse <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--teemast_väljas!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Märgib sõltuvat välja, mis võib või ei pruugi olla valemi väärtusest olenevalt nähtav.<br/><!--teemast_väljas!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Märgib arvutatud välja, mille väärtus määratakse valemi järgi automaatselt.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_FIELD_DELETE'=>'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\\n\\nKas soovite jätkata?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas olete kindel, et soovite selle seose kustutada?<br>Märkus: toimingu lõpetamiseks võib kuluda mitu minutit.',
...
,
'LBL_POPHELP_CALCULATED'=>"Looge selle välja väärtuse määramiseks valem.<br>"
   . "Seda välja värskendavad töövoo definitsioonid ei teosta enam nimetatud tegevust.<br>"
   . "Välju, mis kasutavad valemeid, ei arvutata enam reaalajas "
   . "Sugari iseteenindusportaalis või "
   . "Mobiilses redigeerimisvaate paigutustes.",

'LBL_POPHELP_DEPENDENT'=>"Looge valem, määramaks, kas see väli on paigutuses nähtav.<br/>"
        . "Sõltuvate väljade korral rakendub brauseripõhises mobiilivaates sõltuvusvalem,<br/>"
        . "mis ei kohaldu omarakendustes, nagu iPhone’i Sugar Mobile.<br/>"
        . "Rakendused ei järgi Sugari iseteenindusportaalis nimetatud valemit.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige see väli, kui kasutate selles moodulis kirjete leidmiseks globaalset otsingut.',
