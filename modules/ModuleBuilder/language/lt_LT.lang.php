...
'LBL_CONFIRM_FIELD_DELETE'=>'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete.'
        ...
        . '\\n\\nAr norite tęsti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Ar tikrai norite ištrinti šį ryšį?<br>Pastaba: ši operacija gali užtrukti keletą minučių.',
...
,
'LBL_POPHELP_CALCULATED'=>"Sukurkite formulę šiame laukelyje esančiai vertei nustatyti.<br>"
   . "Darbo sekos apibrėžimai, kuriuose yra veiksmas ir jie yra nustatyti, kad atnaujintų šį lauką, daugiau veiksmo nebevykdys.<br>"
   . "Formules naudojantys laukai nebus apskaičiuojami tikruoju laiku "
   . "„Sugar“ savitarnos portale arba "
   . "mobiliosios redagavimo formos išdėstymuose.",

'LBL_POPHELP_DEPENDENT'=>"Sukurkite formulę kad nustatytumėte, ar šis laukas bus matomas išdėstymuose.<br/>"
        . "Mobiliojoje versijoje priklausomiems laukams bus taikoma priklausomybės formulė, <br/>"
        . "tačiau formulė nebus taikoma savosiose programose, pvz., „Sugar Mobile“, skirtoje iPhone.<br/>"
        . "Formulė nebus taikoma „Sugar“ savitarnos portale.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Ieškodami įrašų globalioje paieškoje šioje versijoje, pasirinkite naudoti šį lauką.',
