...
'LBL_CONFIRM_FIELD_DELETE'=>'Vymazaním tohto vlastného poľa odstránite vlastné pole a všetky údaje súvisiace s vlastným poľom v databáze. Pole sa už nebude zobrazovať v žiadnom z rozložení modulu.'
        ...
        . '\\n\\nChcete pokračovať?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Naozaj chcete vymazať tento vzťah?<br>Poznámka: Dokončenie tejto operácie môže trvať niekoľko minút.',
...
'LBL_POPHELP_CALCULATED'=>"Vytvorte vzorec na určenie hodnoty v tomto poli.<br>"
   . "Definície pracovného postupu obsahujúce akciu, ktoré sú nastavené na aktualizáciu tohto poľa, už nebudú vykonávať túto akciu.<br>"
   . "Polia používajúce vzorce sa nevypočítajú v reálnom čase na "
...
'LBL_POPHELP_DEPENDENT'=>"Vytvorte vzorec na určenie, či je toto pole viditeľné v rozloženiach.<br/>"
        . "Závislé polia budú budú sledovať vzorec závislosti v mobilnom zobrazení založenom na prehliadači, <br/>"
        . "ale nebudú sledovať vzorec v natívnych aplikáciách, napríklad Sugar Mobile for iPhone. <br/>"
        . "Nebudú sledovať vzorec na samoobslužnom portáli Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Vyberte použitie tohto poľa pri vyhľadávaní záznamov s použitím Globálneho vyhľadávania na tomto module.',
