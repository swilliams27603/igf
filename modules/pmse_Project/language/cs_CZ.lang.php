...
$mod_strings = array (
  ...
  'LBL_PMSE_BUTTON_OK' => 'OK',
    ...
    'LBL_PMSE_PROCESS_DEFINITIONS_ENABLED' => 'Aktivováno',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_FORM_OPTION_HOURS' => 'hodin',
    'LBL_PMSE_FORM_OPTION_MINUTES' => 'minut',
    'LBL_PMSE_MESSAGE_CANNOTDROPOUTSIDECANVAS' => 'Nelze umístit prvek mimo plátno',
    ...
    // CONFIRMATIONS
    'LBL_PMSE_CHANGE_ACTION_TYPE_CONFIRMATION' => 'Změna typu akce způsobí ztrátu všech předchozích nastavení pro tuto akci. Chcete pokračovat?',
    // FORMS
    'LBL_PMSE_FORM_TITLE_ACTIVITY' => 'Aktivity',
    ...
    'LBL_PA_FORM_COMBO_NO_MATCHES_FOUND' => 'Nenalezeny žádné shody',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_TEAM' => 'Vybrat uživatele procesu z týmu',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_USER' => 'Vybrat uživatele procesu',
    'LBL_PMSE_FORM_OPTION_CURRENT_USER' => 'Aktuální uživatel',
    'LBL_PMSE_FORM_OPTION_RECORD_OWNER' => 'Vlastník záznamu',
    'LBL_PMSE_FORM_OPTION_SUPERVISOR' => 'Inspektor',
    ...
    // FORMS
    'LBL_PMSE_FORM_TITLE_LABEL_EVENT' => 'Událost',
    ...
    'LBL_PMSE_CONTEXT_MENU_EVENT_BASED_GATEWAY' => 'Brána založená na událosetch',
    'LBL_PMSE_CONTEXT_MENU_DEFAULT_FLOW' => 'standardní flow',
    'LBL_PMSE_CONTEXT_MENU_NONE' => 'žádný',

    // FORMS
    'LBL_PMSE_FORM_TITLE_GATEWAY' => 'Brána',

    'LBL_PMSE_CONTEXT_MENU_DEFAULT_TASK' => '(Activita)',
    'LBL_PMSE_CONTEXT_MENU_DEFAULT_EVENT' => '(Událost)',
    'LBL_PMSE_CONTEXT_MENU_DEFAULT_GATEWAY' => '(Brána)',

    'LBL_PMSE_BPMN_WARNING_PANEL_TITLE' => 'Chyby prvků',
    ...
    'LBL_PMSE_EXPCONTROL_BUSINESS_RULES_EVALUATION_BR' => 'Byznys pravidlo',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_SUPERVISOR' => 'Inspektor',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_OWNER' => 'Vlastník záznamu',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_OPERATOR' => 'Operátor',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ADMIN' => 'je správce',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ADMIN_FULL' => '%TARGET% je správce',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ROLE' => 'má roli',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ROLE_FULL' => '%TARGET% má roli %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER' => 'je uživatel',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER_FULL' => '%TARGET% je uživatel %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ADMIN' => 'není správce',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ADMIN_FULL' => '%TARGET% není správce',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ROLE' => 'nemá roli',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ROLE_FULL' => '%TARGET% nemá roli %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER' => 'není uživatel',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER_FULL' => '%TARGET% není uživatel %VALUE%',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_TITLE' => 'Časový rozsah',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_MONTHS' => 'měsíce',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_WEEKS' => 'týdny',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_DAYS' => 'dny',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_HOURS' => 'hodin',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_MINUTES' => 'minut',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_BASIC' => 'Řetězec, číslo a logická hodnota',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_CURRENCY' => 'Měna:',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_CURRENCY_CURRENCY' => 'Měna:',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_CURRENCY_AMOUNT' => 'Částka',
    ...
    'LBL_PMSE_EMAILPICKER_USER_RECORD_CREATOR' => 'záznam vytvořil',
    'LBL_PMSE_EMAILPICKER_USER_LAST_MODIFIER' => 'záznam naposledy upravil',
    'LBL_PMSE_EMAILPICKER_USER_IS_ASIGNEE' => 'je přiřazen k záznamu',

    'LBL_PMSE_UPDATERFIELD_VARIABLES_LIST_TITLE' => '%MODULE% pole',
    'LBL_PMSE_UPDATERFIELD_ADD_TEAM' => 'Přidat tým...',
    ...
    'LBL_PMSE_MESSAGE_ERROR_ACTIVITY_SCRIPT_TASK' => 'Úloha skriptu musí mít platný typ, který je odlišný od typu [Unassigned]',
    ...
    'LBL_PMSE_IMPORT_PROCESS_DEFINITION_FAILURE' => 'Vytvoření definice procesu se nezdařilo',
    'LBL_PMSE_CANNOT_CONFIGURE_ADD_RELATED_RECORD' => 'Pro tento cílový modul nejsou k dispozici žádné související moduly',
    'LBL_PMSE_PROJECT_NAME_EMPTY' => 'Pole Název definice procesu je povinné, proto se nesmí ukládat jako prázdné.',
