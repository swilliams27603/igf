...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_MESSAGE_REMOVE_ALL_START_CRITERIA' => 'The module is changing so the criteria will be removed as well, since it has no field relationship with the new module.',
    ...
    'LBL_PMSE_FORM_LABEL_READ_ONLY_FIELDS' => 'Read only fields',
    ...
    'LBL_PMSE_MESSAGE_ACTIVITY_NAME_ALREADY_EXISTS' => 'The name "%s" already exists in the shape family.',
    ...
    'LBL_PMSE_EMAILPICKER_MANAGER_CREATED' => 'User in %MODULE% is manager of the creator of the record',
    'LBL_PMSE_EMAILPICKER_MANAGER_LAST_MODIFIED' => 'User in %MODULE% is manager of whoever last modified the record',
    'LBL_PMSE_EMAILPICKER_MANAGER_IS_ASSIGNED' => 'User in %MODULE% is the manager of whoever was last assigned to the record',
    ...
    'LBL_PMSE_MESSAGE_ERROR_INTERMEDIATE_EVENT_INCOMING' => 'Intermediate Event must have one or more sequence flow',
    ...
    'LBL_PMSE_PROJECT_NAME_EMPTY' => 'Process Definition Name should not be saved as blank as it is a required field.',
