...
$mod_strings = array (
  ...
  'LBL_PMSE_BUTTON_OK' => 'OK',
    ...
    'LBL_PMSE_PROCESS_DEFINITIONS_EDIT' => 'Il y a des processus actifs suivant cette définition du processus en cours. Une mise à jour de celle-ci risquerait de compromettre ces processus. Voulez-vous toujours modifier la définition de ce processus ?',
    'LBL_PMSE_DISABLE_CONFIRMATION_PD' => 'Il y a des processus actifs suivant cette définition du processus. Une mise à jour de celle-ci risquerait de compromettre ces processus. Voulez-vous toujours désactiver la définition de ce processus?',

    'LBL_PMSE_PROCESS_DEFINITION_IMPORT_TEXT' => 'Télécharger un fichier .bpm pour importer une définition de processus.',
    ...
    'LBL_PMSE_PROCESS_DEFINITION_IMPORT_BR' => 'La définition de processus a été importée, mais contient une ou plusieurs actions de règles de gestion pour lesquelles des règles de gestion n&#39;ont pas été sélectionnées.',
    'LBL_BPM_IMPORT_SELECT' => 'Cette définition de processus contient les règles de gestion et les modèles d&#39;emails suivants. '
        . 'Veuillez sélectionner ceux que vous voulez importer.',
    'LBL_BUSINESS_RULES' => 'Règles de gestion',
...
//    'LBL_PMSE_LABEL_DELETED_RECORD'=>'The records related to this Process has been removed',
    ...
    'LBL_PMSE_ADAM_DESIGNER_OTHER_MODULES' => 'Module cible',
    'LBL_PMSE_ADAM_DESIGNER_WAIT' => 'Patienter',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_FORM_LABEL_UNIT' => 'Unité de mesure',

    'LBL_PMSE_FORM_OPTION_SELECT' => 'Sélection...',
    'LBL_PMSE_FORM_OPTION_TARGET_MODULE' => 'Module cible',
    'LBL_PMSE_FORM_OPTION_DAYS' => 'Jours',
    'LBL_PMSE_FORM_OPTION_HOURS' => 'Heure(s)',
    'LBL_PMSE_FORM_OPTION_MINUTES' => 'Minute(s)',
    'LBL_PMSE_MESSAGE_CANNOTDROPOUTSIDECANVAS' => 'Impossible de supprimer l&#39;élément à l&#39;extérieur du canvas',
    ...
    // CONFIRMATIONS
    'LBL_PMSE_CHANGE_ACTION_TYPE_CONFIRMATION' => 'En changeant le type d&#39;action, tous les paramètres précédents pour cette action seront perdus. Vous voulez continuer ?',
    // FORMS
    ...
    'LBL_PA_FORM_COMBO_ASSIGN_TO_USER_HELP_TEXT' => 'Sélection...',
    'LBL_PA_FORM_COMBO_NO_MATCHES_FOUND' => 'Aucune correspondance trouvée',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_TEAM' => 'Sélectionnez l&#39;utilisateur du processus dans l&#39;équipe',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_USER' => 'Sélectionnez l&#39;utilisateur du processus',
    'LBL_PMSE_FORM_OPTION_CURRENT_USER' => 'Utilisateur actuel',
    ...
    'LBL_PMSE_CONTEXT_MENU_TIMER' => 'Minuterie',
    ...
    'LBL_PMSE_FORM_LABEL_EMAIL_TEMPLATE' => 'Modèle Email',
    ...
    'LBL_PMSE_EXPCONTROL_FORM_RESPONSE_EVALUATION_TITLE' => 'Évaluation de réponse de formulaire',
    'LBL_PMSE_EXPCONTROL_FORM_RESPONSE_EVALUATION_FORM' => 'Formulaire',
    'LBL_PMSE_EXPCONTROL_FORM_RESPONSE_EVALUATION_STATUS' => 'Statut',
    'LBL_PMSE_EXPCONTROL_BUSINESS_RULES_EVALUATION_TITLE' => 'Évaluation des règles de gestion',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TITLE' => 'Évaluation utilisateur',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_USER' => 'Assigné à',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ADMIN' => 'est admin',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ADMIN_FULL' => '%TARGET% est admin',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ROLE' => 'a le rôle de',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_ROLE_FULL' => '%TARGET% a le rôle de %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER' => 'est utilisateur',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER_FULL' => '%TARGET% est l&#39;utilisateur %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ADMIN' => 'n&#39;est pas admin',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ADMIN_FULL' => '%TARGET% n&#39;est pas admin',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ROLE' => 'n&#39;a pas le rôle de',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_ROLE_FULL' => '%TARGET% n&#39;a pas le rôle de %VALUE%',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER' => 'n&#39;est pas utilisateur',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER_FULL' => '%TARGET% n&#39;est pas l&#39;utilisateur %VALUE%',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_TITLE' => 'Intervalle de temps',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_AMOUNT' => 'Valeur',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_UNIT' => 'Unité de mesure',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_YEARS' => 'années',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_MONTHS' => 'mois',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_WEEKS' => 'semaines',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_DAYS' => 'jours',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_HOURS' => 'heures',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_MINUTES' => 'minutes',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_BASIC' => 'Chaîne, nombre et boolean',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_BASIC_NUMBER' => 'Numéro',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_CURRENCY' => 'Devise',
    ...
    'LBL_PMSE_EXPCONTROL_OPERATOR_EQUAL' => 'Egal',
    ...
    'LBL_PMSE_EXPCONTROL_OPERATOR_STARTS_TEXT' => 'commence par',
    'LBL_PMSE_EXPCONTROL_OPERATOR_ENDS_TEXT' => 'se termine par',
    'LBL_PMSE_EXPCONTROL_OPERATOR_CONTAINS_TEXT' => 'contient',
    ...
    'LBL_PMSE_EXPCONTROL_OPERATOR_NOT_EQUAL_DATE' => 'pas égal à',
    ...
    'LBL_PMSE_EMAILPICKER_USER_CREATED' => 'Utilisateur dans %MODULE% qui a créé le dossier',
    'LBL_PMSE_EMAILPICKER_USER_LAST_MODIFIED' => 'Utilisateur dans %MODULE% qui a modifié l&#39;enregistrement en dernier',
    'LBL_PMSE_EMAILPICKER_USER_IS_ASSIGNED' => 'Utilisateur dans %MODULE% qui est affecté à l&#39;enregistrement',
    'LBL_PMSE_EMAILPICKER_USER_WAS_ASSIGNED' => 'Utilisateur dans %MODULE% qui a été affecté à l&#39;enregistrement',
    'LBL_PMSE_EMAILPICKER_MANAGER_CREATED' => 'Utilisateur de %MODULE% qui est responsable de la personne qui a créé le dossier',
    'LBL_PMSE_EMAILPICKER_MANAGER_LAST_MODIFIED' => 'Utilisateur de %MODULE% qui est responsable de la personne qui a modifié l&#39;enregistrement en dernier',
    'LBL_PMSE_EMAILPICKER_MANAGER_IS_ASSIGNED' => 'Utilisateur de %MODULE% qui est responsable de la personne qui est affectée à l&#39;enregistrement',
    'LBL_PMSE_EMAILPICKER_MANAGER_WAS_ASSIGNED' => 'Utilisateur de %MODULE% qui est responsable de la personne qui a été affectée à l&#39;enregistrement',
    'LBL_PMSE_EMAILPICKER_ROLE_ITEM' => 'rôle : %ROLE%',
    'LBL_PMSE_EMAILPICKER_TEAM_ITEM' => 'équipe : %TEAM%',
    'LBL_PMSE_EMAILPICKER_SUGGESTIONS' => 'Suggestions',
    'LBL_PMSE_EMAILPICKER_RESULTS_TITLE' => '%NUMBER% suggestion(s) pour "%TEXT%"',
    'LBL_PMSE_EMAILPICKER_USER_RECORD_CREATOR' => 'a créé le dossier',
    'LBL_PMSE_EMAILPICKER_USER_LAST_MODIFIER' => 'a modifié l&#39;enregistrement en dernier',
    'LBL_PMSE_EMAILPICKER_USER_IS_ASIGNEE' => 'est affecté à l&#39;enregistrement',

    'LBL_PMSE_UPDATERFIELD_VARIABLES_LIST_TITLE' => 'champs du module %MODULE%',
    'LBL_PMSE_UPDATERFIELD_ADD_TEAM' => 'Ajouter une équipe...',
    ...
    'LBL_PMSE_MESSAGE_ERROR_ACTIVITY_SCRIPT_TASK' => 'La tâche de script doit être d&#39;un type valide différent de [Unassigned]',
    ...
    'LBL_PMSE_MESSAGE_ERROR_GATEWAY_CONVERGING_OUTGOING' => 'Une passerelle ne peut pas avoir un seul flux de sortie',
    ...
    'LBL_PMSE_CANNOT_CONFIGURE_ADD_RELATED_RECORD' => 'Il n&#39;existe aucun module associé pour ce module cible',
    'LBL_PMSE_PROJECT_NAME_EMPTY' => 'Le nom de définition du processus ne doit pas être enregistré non rempli car ce champ est obligatoire.',

    'LBL_PMSE_INVALID_EXPRESSION_SYNTAX' => 'Syntaxe de l&#39;expression non valide.',
