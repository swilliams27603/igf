 ...
 * PLACE ANY CUSTOMIZATIONS IN ibm_Legal_Entity
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class ibm_Legal_Entity_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'ibm_Legal_Entity';
    public $object_name = 'ibm_Legal_Entity';
    public $table_name = 'ibm_legal_entity';
