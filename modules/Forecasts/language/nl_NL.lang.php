...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren. <br><br>Houd er rekening mee dat de bereikinstellingen na de eerste vermelding niet kunnen worden gewijzigd. Voor bijgewerkte gevallen is de bereikinstelling vergrendeld in de huidige voorspellingsgegevens.<br><br>U kunt twee of meer categorieën selecteren o0p basis van het waarschijnlijkheidsbereik of u kunt categorieën aanmaken die niet zijn gebaseerd op waarschijnlijkheid. <br><br>Links van uw aangepaste categorieën bevinden zich selectievakjes. Deze kunt u gebruiken om aan te geven welk bereik wordt opgenomen in het voorspelde bedrag en aan managers wordt gerapporteerd. <br><br>Een gebruiker kan de status insluiten/uitsluiten en de categorie {{forecastByModule}} handmatig veranderen vanuit het werkblad.',
