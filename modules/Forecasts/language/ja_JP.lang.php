...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'どのように {{forecastByModule}} をカテゴリー分けしたいかを設定します。<br><br>範囲設定は最初のコミット後に変更できませんのでご注意ください。アップグレードされたインスタンスの場合、範囲設定は既存の予測データでロックされます。<br><br>確率範囲に基づき、2 つ以上のカテゴリーを選択したり、確率に基づいていないカテゴリーを作成することができます。<br><br>ユーザーは {{forecastByModule}} の状態やカテゴリーを手動でワークシートに追加/削除することができます。',
