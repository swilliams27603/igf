...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigūruokite, kaip norite {{forecastByModule}} skirstyti į kategorijas. <br><br>Atkreipkite dėmesį, kad pirmą kartą nusiuntus diapazono parametrų koreguoti nebegalima. Atnaujintų egzempliorių atveju diapazono parametre naudojami esami prognozės duomenys ir jų keisti negalima.<br><br>Galite pasirinkti dvi ar daugiau kategorijų, pagrįstų tikimybės diapazonais, arba sukurti kategorijų, kurios nėra pagrįstos tikimybe. <br><br>Kairėje tinkintų kategorijų pusėje yra žymimieji langeliai; juos pažymėdami pasirinkite diapazonus, kurie bus įtraukti į prognozės duomenis, fiksuojamus ir perduodamus vadovams. <br><br>Vartotojas savo darbalapyje rankiniu būdu gali pakeisti {{forecastByModule}} įtraukimo / neįtraukimo būsena ir kategoriją.',
