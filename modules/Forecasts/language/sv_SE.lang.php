...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Notera att inställningarnas spann inte kan ändras efter den första verkställande. För uppgraderade instanser, är spannet låst med befintlig prognos data.<br><br>Du kan välja två eller fler kategorier, baserat på sannolikhet, eller skapa kategorier som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka intervall som ska inkluderas i prognosens belopp och rapporteras till chefer. <br><br>En användare kan ändra inkludera/exkludera status och kategori för {{forecastByModule}} manuellt från deras arbetsblad.',
