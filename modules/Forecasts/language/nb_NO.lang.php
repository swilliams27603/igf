...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}. <br><br>Merk at områdeinnstillinger ikke kan endres etter første forpliktelse. For oppgraderte forekomster, er områdeinnstillingen låst inn med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på bærbarhetsområder eller opprette kategorier som ikke er basert på sannsynlighet. <br><br>Det er avmerkingsbokser til venstre for dine egendefinerte kategorier; bruk disse for å bestemme hvilke  områder som vil bli inkludert i prognosebeløpet forpliktet og rapportert til sjefer. <br><br>En bruker kan inkludere ekskluder/ekskluder-kategorien for {{forecastByModule}} manuelt fra arbeidsarket deres.',
