...
$mod_strings = array (
  ...
  'LNK_ADVANCED_REPORTING' => 'Hantera avancerade rapporter',
    'LNK_REPORT_SCHEDULES' => 'Rapportscheman',
...
// report_name
  ...
  'LBL_GROUP_BY_REQUIRED'=>'Summeringsrapport med en grupperingskolumn och en summeringskolumn krävs för att kunna generera en graf',
    ...
    'LBL_NO_VIEW_PERMISSIONS' => 'Du har inte behörighet att se den här rapporten.',
	'LBL_NONE' => '-- ingen --',
    ...
    'LBL_SUBJECT_SCHEDULED_REPORT' => 'Schemalagd rapport: ',
    'LBL_SUBJECT_AS_OF' => ' som av ',
	'LBL_HELLO' => 'Hej',
    'LBL_SCHEDULED_REPORT_MSG_INTRO' => 'Bifogat finns en automatiskt genererad rapport som har schemalagts för dig.',
    'LBL_SCHEDULED_REPORT_MSG_BODY1' => 'Rapportnamn: ',
    'LBL_SCHEDULED_REPORT_MSG_BODY2' => 'Rapport körningsdatum och tid: ',
    ...
    'LBL_REPORT_SCHEDULE_TITLE' => 'Skapa schema',
    'LBL_VIEW_SCHEDULES_TITLE' => 'Se scheman',
    ...
    'STOCK_REPORT_TITLE_1' => 'Antal öppna uppgifter per användare per vecka',
    'STOCK_REPORT_TITLE_2' => 'Konton per tilldelad till användare',
    'STOCK_REPORT_TITLE_3' => 'Mina öppna felrapporter efter prioritet',
    'STOCK_REPORT_TITLE_5' => 'Öppna ärenden per användare utifrån prioritet',
    'STOCK_REPORT_TITLE_6' => 'Lista över möjliga kunder utan samtycke',
    'STOCK_REPORT_TITLE_7' => 'Öppna offerter utifrån nivå per avslutad månad',
    'STOCK_REPORT_TITLE_8' => 'Skapade felrapporter per månad utifrån prioritet',
    'STOCK_REPORT_TITLE_9' => 'Datasekretessaktivitet som avslutats och förkastats varje månad',
    'STOCK_REPORT_TITLE_10' => 'Nyligen skapad datasekretessaktivitet',
    'STOCK_REPORT_TITLE_11' => 'Öppna offerter som löper ut den här månaden',
    'STOCK_REPORT_TITLE_12' => 'Öppna ärenden per användare per status',
    'STOCK_REPORT_TITLE_13' => 'Felrapporter per produktkategori utifrån status',
    'STOCK_REPORT_TITLE_14' => 'Antal möjliga kunder (inte konverterade) utifrån land',
    'STOCK_REPORT_TITLE_15' => 'Kommande schemalagda samtal per konto',
    'STOCK_REPORT_TITLE_17' => 'Försenad datasekretessaktivitet',
    'STOCK_REPORT_TITLE_18' => 'Öppna möjliga kunder per användare',
    'STOCK_REPORT_TITLE_19' => 'Skapade buggrapporter per månad per kategori',
    'STOCK_REPORT_TITLE_21' => 'Avslutade uppgifter per användare per vecka det här kvartalet',
    'STOCK_REPORT_TITLE_22' => 'Sammanfattning av skapade buggrapporter utifrån status per vecka',
    'STOCK_REPORT_TITLE_24' => 'Konverterade möjliga kunder - förlorade per månad',
    'STOCK_REPORT_TITLE_25' => 'Planerade veckosamtal det här kvartalet per användare',
    'STOCK_REPORT_TITLE_26' => 'Antal mål land',
    'STOCK_REPORT_TITLE_27' => 'Utförda veckomöten det här kvartalet per användare',
    'STOCK_REPORT_TITLE_28' => 'Vunna och förlorade offerter per användare',
    'STOCK_REPORT_TITLE_29' => 'Antal datasekretessaktiviteter som skapats varje månad per typ',
    'STOCK_REPORT_TITLE_30' => 'Sammanfattning av skapade felrapporter per källa per vecka',
    'STOCK_REPORT_TITLE_31' => 'Sammanfattning av öppna ärenden efter prioritet',
    'STOCK_REPORT_TITLE_32' => 'Datasekretessaktivitet som förfaller nu',
    'STOCK_REPORT_TITLE_33' => 'Öppna ärenden per månad per användare',
    'STOCK_REPORT_TITLE_34' => 'Nya ärenden per månad',
    'STOCK_REPORT_TITLE_35' => 'Konton per typ per industri',
    'STOCK_REPORT_TITLE_36' => 'Möjliga kunder per källa för möjliga kunder',
    'STOCK_REPORT_TITLE_37' => 'Mina nya kundkonton',
    'STOCK_REPORT_TITLE_38' => 'Öppna samtal',
    'STOCK_REPORT_TITLE_39' => 'Öppna möten',
    'STOCK_REPORT_TITLE_40' => 'Öppna uppgifter',
    'STOCK_REPORT_TITLE_41' => 'Min användnings statistik (idag)',
    'STOCK_REPORT_TITLE_42' => 'Min användnings statistik (senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_43' => 'Min användnings statistik (senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_44' => 'Min modul statistik (idag)',
    'STOCK_REPORT_TITLE_45' => 'Min modul statistik (senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_46' => 'Min modul statistik (senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_47' => 'Användarstatistik (senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_48' => 'Användarstatistik (senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_49' => 'Moduler som används av Mina Direkta Rapporter (Senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_50' => 'Tunga frågor',
    'STOCK_REPORT_TITLE_51' => 'Mina ändrade poster (senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_52' => 'Mina ändrade poster (senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_53' => 'Poster ändrade av Mina Direkta Rapporter (Senaste 30 dagarna)',
    'STOCK_REPORT_TITLE_54' => 'Aktiva användarsessioner (Senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_55' => 'Sammanfattning av användarsessioner (Senaste 7 dagarna)',
    'STOCK_REPORT_TITLE_56' => 'Mina öppna ärenden efter prioritet',
    'STOCK_REPORT_TITLE_58' => 'Antal möjliga kunder som skapats per vecka',
    'STOCK_REPORT_TITLE_59' => 'Sammanfattning av skapade felrapporter per prioritet per vecka',
    'STOCK_REPORT_TITLE_60' => 'Inplanerade veckomöten det här kvartalet per användare',
    'STOCK_REPORT_TITLE_61' => 'Mina öppna möjliga kunder',
    'STOCK_REPORT_TITLE_62' => 'Skapade konton per användare per månad',
    'STOCK_REPORT_TITLE_63' => 'Det här kvartalets utförda samtal per vecka av användare',
    'STOCK_REPORT_TITLE_64' => 'Sammanfattning av skapade ärenden utifrån status per vecka',
    'STOCK_REPORT_TITLE_65' => 'Möjliga kunder som skapats av användare per månad',
    'STOCK_REPORT_TITLE_66' => 'Öppna datasekretessaktiviteter per typ',
    'STOCK_REPORT_TITLE_67' => 'Lista över kontakter utan samtycke',
    'STOCK_REPORT_TITLE_68' => 'Licensierad användarlista',
    'STOCK_REPORT_TITLE_69' => 'Ärenden utan samtal, möten, uppgifter eller e-post',
    'STOCK_REPORT_TITLE_70' => 'Skapade kontakter per användare per månad',
    'STOCK_REPORT_TITLE_71' => 'Skapade offerter per användare per månad',
    'STOCK_REPORT_TITLE_72' => 'Förteckning över öppna datasekretessaktiviteter',
    'STOCK_REPORT_TITLE_73' => 'Möjliga kunder utan samtal, möten, uppgifter eller e-post',
    'STOCK_REPORT_TITLE_74' => 'Sammanfattning av skapade ärenden per prioritet per vecka',
    'STOCK_REPORT_TITLE_76' => 'Vunna och förlorade offerter per månad',
    'STOCK_REPORT_TITLE_77' => 'Öppna buggrapporter per användare per prioritet',
    'STOCK_REPORT_TITLE_78' => 'Öppna offerter per status',
    'STOCK_REPORT_TITLE_79' => 'Antal skapade offerter av användare per månad',
    'STOCK_REPORT_TITLE_80' => 'Mina kunder utifrån område',
    'STOCK_REPORT_TITLE_81' => 'Uppgifter som förfaller den här veckan',
    'STOCK_REPORT_TITLE_82' => 'Offerter konverterade av användare',
    'STOCK_REPORT_TITLE_83' => 'Kommande möten schemalagda per konto',
    'STOCK_REPORT_TITLE_84' => 'Sammanfattning av skapade ärenden per källa per vecka',
    'STOCK_REPORT_TITLE_85' => 'Lista över e-postadresser som inte önskar utskick',
    'STOCK_REPORT_TITLE_86' => 'Förteckning över öppna datasekretessaktiviter som tilldelats mig',
    'STOCK_REPORT_TITLE_88' => 'Lista över e-postadresser som önskar utskick',
    'STOCK_REPORT_TITLE_90' => 'Öppna offerter per status per användare',
    'STOCK_REPORT_TITLE_91' => 'Mina öppna uppgifter per prioritet och status',
    'STOCK_REPORT_TITLE_92' => 'Antal kontakter per land',
    'STOCK_REPORT_TITLE_93' => 'Lista över team och licensierade användare',
    'STOCK_REPORT_TITLE_94' => 'Nyligen avslutade offerter',
    'STOCK_REPORT_TITLE_95' => 'Öppna buggrapporter per användare per status',
    'STOCK_REPORT_TITLE_96' => 'Möjliga kunder som skapats per källa per månad',
    // Stock reports titles - ent
    'STOCK_REPORT_TITLE_97_ENT' => 'Topp inkomstbringande produkter det här året',
    'STOCK_REPORT_TITLE_98_ENT' => 'Min pipeline funnel (intäkt radposter)',
    'STOCK_REPORT_TITLE_99_ENT' => 'Möjligheter utan samtal, möten, uppgifter eller e-post',
    'STOCK_REPORT_TITLE_100_ENT' => 'Topp försäljningsrepresentanter det här kvartalet',
    'STOCK_REPORT_TITLE_101_ENT' => 'Pipeline funnel (intäkt radposter)',
    'STOCK_REPORT_TITLE_102_ENT' => 'Total försäljning per kvartal',
    'STOCK_REPORT_TITLE_103_ENT' => 'Öppna möjligheter och antal möten',
    'STOCK_REPORT_TITLE_104_ENT' => 'Pipeline per användare (intäkt radposter)',
    'STOCK_REPORT_TITLE_105_ENT' => 'Total försäljning per kvartal per användare',
    'STOCK_REPORT_TITLE_106_ENT' => 'Öppna affärsmöjligheter per användare utifrån förväntad slutmånad',
    'STOCK_REPORT_TITLE_107_ENT' => 'Antal skapade affärsmöjligheter per användare per månad',
    'STOCK_REPORT_TITLE_108_ENT' => 'Mina öppna affärsmöjligheter',
    'STOCK_REPORT_TITLE_109_ENT' => 'Antal skapade affärsmöjligheter per team per månad',
    'STOCK_REPORT_TITLE_110_ENT' => 'Pipeline per Typ per Team',
    'STOCK_REPORT_TITLE_111_ENT' => 'Pipeline per Team per Användare',
    'STOCK_REPORT_TITLE_114_ENT' => 'Alla öppna möjligheter',
    'STOCK_REPORT_TITLE_115_ENT' => 'Alla stängda möjligheter',
    'STOCK_REPORT_TITLE_116_ENT' => 'Intäkter för radartiklar sålda det här kvartalet per typ',
    'STOCK_REPORT_TITLE_117_ENT' => 'Öppna affärsmöjligheter utifrån förväntad slutmånad',
    'STOCK_REPORT_TITLE_119_ENT' => 'Intäkter för radartiklar per produkt',
    'STOCK_REPORT_TITLE_120_ENT' => 'Vinster och förluster per användare det här kvartalet',
    'STOCK_REPORT_TITLE_121_ENT' => 'Öppna affärsmöjligheter och antal samtal',
    'STOCK_REPORT_TITLE_122_ENT' => 'Försäljning per kvartal per möjliga kunder per källa',
    'STOCK_REPORT_TITLE_123_ENT' => 'Öppna affärsmöjligheter per typ per förväntad slutmånad',
    'STOCK_REPORT_TITLE_124_ENT' => 'Skapade affärsmöjligheter per möjliga kunder per månad',
    ...
    'LBL_SCHEDULE_REPORT_BUTTON' => 'Skapa schema',
    'LBL_VIEW_SCHEDULES_BUTTON' => 'Se scheman',
    ...
    'LBL_FILTER_STOCK_REPORTS' => 'Lager rapporter',
    'LBL_FILTER_NON_STOCK_REPORTS' => 'Inget lager rapporter',
