...
$mod_strings = array (
  ...
  'LNK_ADVANCED_REPORTING' => 'Gestisci Reporting Enterprise',
    'LNK_REPORT_SCHEDULES' => 'Pianificazioni di report',
  'LBL_REPORTS' => 'Report',
  'LBL_TITLE' => 'Titolo',
...
// report_name
  ...
  'LBL_GROUP_BY_REQUIRED'=>'Per costruire un grafico sono richieste almeno un raggruppamento e una colonna riassuntiva.',
    ...
    'LBL_NO_VIEW_PERMISSIONS' => 'Non hai il permesso per visualizzare questo report.',
	'LBL_NONE' => '-- nessuno --',
    ...
    'LBL_SUBJECT_SCHEDULED_REPORT' => 'Report pianificato: ',
    'LBL_SUBJECT_AS_OF' => ' a partire da ',
	'LBL_HELLO' => 'Ciao',
    'LBL_SCHEDULED_REPORT_MSG_INTRO' => 'In allegato un report generato automaticamente che è stato pianificato per te.',
    'LBL_SCHEDULED_REPORT_MSG_BODY1' => 'Nome report: ',
    'LBL_SCHEDULED_REPORT_MSG_BODY2' => 'Date e ora di esecuzione del report: ',
    ...
    'LBL_REPORT_SCHEDULE_TITLE' => 'Crea pianificazione',
    'LBL_VIEW_SCHEDULES_TITLE' => 'Visualizza pianificazioni',
    ...
    'STOCK_REPORT_TITLE_1' => 'Numero di attività aperte dagli utenti per settimana',
    'STOCK_REPORT_TITLE_2' => 'Account per assegnazione a utente',
    'STOCK_REPORT_TITLE_3' => 'I miei bug aperti per priorità',
    'STOCK_REPORT_TITLE_5' => 'Reclami aperti per utente per priorità',
    'STOCK_REPORT_TITLE_6' => 'Elenco di lead senza consenso',
    'STOCK_REPORT_TITLE_7' => 'Offerte aperte per fase per mese di chiusura',
    'STOCK_REPORT_TITLE_8' => 'Bug creati per mese per priorità',
    'STOCK_REPORT_TITLE_9' => 'Attività di privacy completata e respinta ogni mese',
    'STOCK_REPORT_TITLE_10' => 'Attività di privacy dei dati creata di recente',
    'STOCK_REPORT_TITLE_11' => 'Offerte aperte in scadenza in questo mese',
    'STOCK_REPORT_TITLE_12' => 'Reclami aperti per utente per stato',
    'STOCK_REPORT_TITLE_13' => 'Bug per categoria di prodotto per stato',
    'STOCK_REPORT_TITLE_14' => 'Nome di lead (non convertiti) per paese',
    'STOCK_REPORT_TITLE_15' => 'Prossime chiamate pianificate per azienda',
    'STOCK_REPORT_TITLE_17' => 'Attività di privacy dei dati scaduta',
    'STOCK_REPORT_TITLE_18' => 'Lead aperti per utente',
    'STOCK_REPORT_TITLE_19' => 'Bug creati per mese per categoria',
    'STOCK_REPORT_TITLE_21' => 'Attività completate dagli utenti per settimana questo trimestre',
    'STOCK_REPORT_TITLE_22' => 'Riepilogo dei bug per stato per settimana di creazione',
    'STOCK_REPORT_TITLE_24' => 'Lead convertiti - Persi per mese',
    'STOCK_REPORT_TITLE_25' => 'Chiamate settimanali pianificate questo trimestre per utente',
    'STOCK_REPORT_TITLE_26' => 'Numero di obiettivi per paese',
    'STOCK_REPORT_TITLE_27' => 'Riunioni settimanali tenute questo trimestre per utente',
    'STOCK_REPORT_TITLE_28' => 'Offerte vite perse per utente',
    'STOCK_REPORT_TITLE_29' => 'Numero di attività di privacy dei dati create ciascun mese per tipo',
    'STOCK_REPORT_TITLE_30' => 'Riepilogo dei bug per fonte per settimana di creazione',
    'STOCK_REPORT_TITLE_31' => 'Riepilogo dei reclami aperti per priorità',
    'STOCK_REPORT_TITLE_32' => 'Attività di privacy dei dati in carico ora',
    'STOCK_REPORT_TITLE_33' => 'Reclami Aperti per Mese per Utente',
    'STOCK_REPORT_TITLE_34' => 'Nuovi reclami per Mese',
    'STOCK_REPORT_TITLE_35' => 'Aziende per Tipo per Settore',
    'STOCK_REPORT_TITLE_36' => 'Leads per Fonte del Lead',
    'STOCK_REPORT_TITLE_37' => 'I miei nuovi clienti',
    'STOCK_REPORT_TITLE_38' => 'Chiamate da effettuare',
    'STOCK_REPORT_TITLE_39' => 'Riunioni da effettuare',
    'STOCK_REPORT_TITLE_40' => 'Attività Aperte',
    'STOCK_REPORT_TITLE_41' => 'Le mie metriche utilizzate (Oggi)',
    'STOCK_REPORT_TITLE_42' => 'Le mie metriche utilizzate (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_43' => 'Le mie metriche utilizzate (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_44' => 'I miei moduli utilizzati (Oggi)',
    'STOCK_REPORT_TITLE_45' => 'I miei moduli utilizzati (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_46' => 'I miei moduli utilizzati (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_47' => 'Users Usage Metrics (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_48' => 'Users Usage Metrics (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_49' => 'Moduli Utilizzati per i Miei Report Diretti (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_50' => 'Query lente',
    'STOCK_REPORT_TITLE_51' => 'I miei report modificati (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_52' => 'I miei record modificati di recente (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_53' => 'Record Modificati dai miei report diretti (Ultimi 30 Giorni)',
    'STOCK_REPORT_TITLE_54' => 'Sessioni Attive per Utente (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_55' => 'Riassunto Sessioni per Utente (Ultimi 7 Giorni)',
    'STOCK_REPORT_TITLE_56' => 'I miei reclami aperti per priorità',
    'STOCK_REPORT_TITLE_58' => 'Numero di lead creati per settimana',
    'STOCK_REPORT_TITLE_59' => 'Riepilogo dei bug per priorità per settimana di creazione',
    'STOCK_REPORT_TITLE_60' => 'Riunioni settimanali pianificate questo trimestre per utente',
    'STOCK_REPORT_TITLE_61' => 'I miei lead aperti',
    'STOCK_REPORT_TITLE_62' => 'Account creati per utente per mese',
    'STOCK_REPORT_TITLE_63' => 'Chiamate settimanali effettuate questo trimestre per utente',
    'STOCK_REPORT_TITLE_64' => 'Riepilogo dei reclami per stato per settimana di creazione',
    'STOCK_REPORT_TITLE_65' => 'Lead creati per utente per mese',
    'STOCK_REPORT_TITLE_66' => 'Attività di privacy dei dati per tipo',
    'STOCK_REPORT_TITLE_67' => 'Elenco di contatti senza consenso',
    'STOCK_REPORT_TITLE_68' => 'Elenco utenti con licenza',
    'STOCK_REPORT_TITLE_69' => 'Reclami senza chiamate, riunioni, attività o email',
    'STOCK_REPORT_TITLE_70' => 'Contatti creati per utente per mese',
    'STOCK_REPORT_TITLE_71' => 'Offerte creati per utenti per mese',
    'STOCK_REPORT_TITLE_72' => 'Elenco di attività di privacy dei dati aperte',
    'STOCK_REPORT_TITLE_73' => 'Lead senza chiamate, riunioni, attività o email',
    'STOCK_REPORT_TITLE_74' => 'Riepilogo dei reclami per priorità per settimana di creazione',
    'STOCK_REPORT_TITLE_76' => 'Offerte vite perse per mese',
    'STOCK_REPORT_TITLE_77' => 'Bug aperti per utente per priorità',
    'STOCK_REPORT_TITLE_78' => 'Offerte aperte per fase',
    'STOCK_REPORT_TITLE_79' => 'Numero di offerte create per utenti per mese',
    'STOCK_REPORT_TITLE_80' => 'I miei clienti per area',
    'STOCK_REPORT_TITLE_81' => 'Attività in carico questa settimana',
    'STOCK_REPORT_TITLE_82' => 'Lead convertiti per utente',
    'STOCK_REPORT_TITLE_83' => 'Prossime riunioni pianificate per azienda',
    'STOCK_REPORT_TITLE_84' => 'Riepilogo dei reclami per fonte per settimana di creazione',
    'STOCK_REPORT_TITLE_85' => 'Elenco di email di esclusione',
    'STOCK_REPORT_TITLE_86' => 'Elenco di attività di privacy dei dati assegnate a me',
    'STOCK_REPORT_TITLE_88' => 'Elenco di email con decisione di iscriversi',
    'STOCK_REPORT_TITLE_90' => 'Offerte aperte per fase per utente',
    'STOCK_REPORT_TITLE_91' => 'Le mie attività aperte per priorità e stato',
    'STOCK_REPORT_TITLE_92' => 'Numero di contatti per paese',
    'STOCK_REPORT_TITLE_93' => 'Elenco di team e utenti con licenza',
    'STOCK_REPORT_TITLE_94' => 'Offerte chiuse di recente',
    'STOCK_REPORT_TITLE_95' => 'Bug aperti per utente per stato',
    'STOCK_REPORT_TITLE_96' => 'Lead creati per fonte per mese',
    // Stock reports titles - ent
    'STOCK_REPORT_TITLE_97_ENT' => 'Prodotti con maggiore incasso quest&#39;anno',
    'STOCK_REPORT_TITLE_98_ENT' => 'Il mio funnel pipeline (Elementi dell&#39;opportunità)',
    'STOCK_REPORT_TITLE_99_ENT' => 'Opportunità senza chiamate, riunioni, attività o email',
    'STOCK_REPORT_TITLE_100_ENT' => 'Migliori rappresentanti commerciali del trimestre',
    'STOCK_REPORT_TITLE_101_ENT' => 'Funnel pipeline (Elementi dell&#39;opportunità)',
    'STOCK_REPORT_TITLE_102_ENT' => 'Vendite totali per trimestre',
    'STOCK_REPORT_TITLE_103_ENT' => 'Opportunità aperte e numero di riunioni',
    'STOCK_REPORT_TITLE_104_ENT' => 'Pipeline per utente (Elementi dell&#39;opportunità)',
    'STOCK_REPORT_TITLE_105_ENT' => 'Vendite totali per trimestre per utente',
    'STOCK_REPORT_TITLE_106_ENT' => 'Opportunità aperte per utente per previsione mese di chiusura',
    'STOCK_REPORT_TITLE_107_ENT' => 'Numero di opportunità create per utente per mese',
    'STOCK_REPORT_TITLE_108_ENT' => 'Le mie opportunità aperte',
    'STOCK_REPORT_TITLE_109_ENT' => 'Numero di opportunità create per team per mese',
    'STOCK_REPORT_TITLE_110_ENT' => 'Pipeline per Tipo per Team',
    'STOCK_REPORT_TITLE_111_ENT' => 'Pipeline per Gruppo per Utente',
    'STOCK_REPORT_TITLE_114_ENT' => 'Tutte le Opportunità Aperte',
    'STOCK_REPORT_TITLE_115_ENT' => 'Tutte le Opportunità Chiuse',
    'STOCK_REPORT_TITLE_116_ENT' => 'Elementi dell&#39;opportunità venduti per tipo questo trimestre',
    'STOCK_REPORT_TITLE_117_ENT' => 'Opportunità aperte per previsione mese di chiusura',
    'STOCK_REPORT_TITLE_119_ENT' => 'Elementi dell&#39;opportunità per prodotto',
    'STOCK_REPORT_TITLE_120_ENT' => 'Vincite e perdite per utenti questo trimestre',
    'STOCK_REPORT_TITLE_121_ENT' => 'Opportunità aperte e numero di chiamate',
    'STOCK_REPORT_TITLE_122_ENT' => 'Vendite per trimestre per fonte lead',
    'STOCK_REPORT_TITLE_123_ENT' => 'Opportunità aperte per tipo per previsione mese di chiusura',
    'STOCK_REPORT_TITLE_124_ENT' => 'Opportunità create per fonte lead per mese',
    ...
    'LBL_SCHEDULE_REPORT_BUTTON' => 'Crea pianificazione',
    'LBL_VIEW_SCHEDULES_BUTTON' => 'Visualizza pianificazioni',
    ...
    'LBL_FILTER_STOCK_REPORTS' => 'Report stock',
    'LBL_FILTER_NON_STOCK_REPORTS' => 'Nessun report stock',
