...
$mod_strings = array (
  ...
  'LNK_ADVANCED_REPORTING' => 'Управление на разширени справки',
    'LNK_REPORT_SCHEDULES' => 'График на справките',
  'LBL_REPORTS' => 'Справки',
  'LBL_TITLE' => 'Заглавие',
  ...
  'LBL_CALL_LIST_BY_LAST_DATE_CONTACTED' => 'Списък с обаждания според деня на последния контакт',
  ...
  'LBL_UN_PUBLISH' => 'отмяна на публикуване',
...
// report_name
  ...
  'LBL_BEFORE' => 'Преди',
  'LBL_AFTER' => 'След',
  'LBL_IS_BETWEEN' => 'Е между',
  'LBL_NOT_ON' => 'С изключване на',
  'LBL_CONTAINS' => 'Съдържа',
  'LBL_DOES_NOT_CONTAIN' => 'Без съдържание',
  ...
  'LBL_LIST_REPORT_NAME' => 'Име',
  'LBL_PROSPECT_REPORTS'=>'Справка Целеви клиенти',
  'LBL_CHART_TYPE'=>'Тип на графиката',
  ...
  'LBL_GROUP_BY_REQUIRED'=>'За визуализиране на графиката следва условията Групиране по и Колони за обобщаване да имат въведени стойности.<br>',
    ...
    'LBL_NO_VIEW_PERMISSIONS' => 'Не разполагате с необходимите права за достъп за разглеждане на тази справка.',
    ...
    'LBL_SUBJECT_SCHEDULED_REPORT' => 'Насрочена справка: ',
    'LBL_SUBJECT_AS_OF' => ' от ',
	'LBL_HELLO' => 'Здравей',
    'LBL_SCHEDULED_REPORT_MSG_INTRO' => 'Приложена автоматично генерирана справка, насрочена за вас.',
    'LBL_SCHEDULED_REPORT_MSG_BODY1' => 'Име на справката: ',
    'LBL_SCHEDULED_REPORT_MSG_BODY2' => 'Дата и час на справката: ',
    ...
    'LBL_REPORT_SCHEDULE_TITLE' => 'Създаване на график',
    'LBL_VIEW_SCHEDULES_TITLE' => 'Преглеждане на графиците',
    ...
    'DEFAULT_REPORT_TITLE_5' => 'Списък с обаждания според деня на последния контакт',
    ...
    'DEFAULT_REPORT_TITLE_43' => 'Отговорници по клиенти',
  	...
  	'DEFAULT_REPORT_TITLE_46' => 'Възможности по тип',
    ...
    'STOCK_REPORT_TITLE_1' => 'Брой текущи задачи по потребители и по седмица',
    'STOCK_REPORT_TITLE_2' => 'Профили по присвояване на потребител',
    'STOCK_REPORT_TITLE_3' => 'Текущите ми проблеми по приоритет',
    'STOCK_REPORT_TITLE_5' => 'Текущи казуси по потребител и по приоритет',
    'STOCK_REPORT_TITLE_6' => 'Списък на потенциални клиенти без дадено съгласие',
    'STOCK_REPORT_TITLE_7' => 'Текущи оферти по етап и по месец на реализиране',
    'STOCK_REPORT_TITLE_8' => 'Създадени проблеми по месец и по приоритет',
    'STOCK_REPORT_TITLE_9' => 'Дейности по поверителност на данните, изпълнени и отхвърлени всеки месец',
    'STOCK_REPORT_TITLE_10' => 'Дейност за поверителност на данните създадена наскоро',
    'STOCK_REPORT_TITLE_11' => 'Текущи оферти, които изтичат този месец',
    'STOCK_REPORT_TITLE_12' => 'Текущи казуси по потребител и по статус',
    'STOCK_REPORT_TITLE_13' => 'Проблеми по категория на продукта и по статус',
    'STOCK_REPORT_TITLE_14' => 'Брой потенциални клиенти (непреобразувани) по страна',
    'STOCK_REPORT_TITLE_15' => 'Предстоящи обаждания, насрочени по профил',
    'STOCK_REPORT_TITLE_17' => 'Просрочени дейности за поверителност на данните',
    'STOCK_REPORT_TITLE_18' => 'Текущи потенциални клиенти по потребител',
    'STOCK_REPORT_TITLE_19' => 'Създадени проблеми по месец и по категория',
    'STOCK_REPORT_TITLE_21' => 'Приключени задачи по потребители и по седмица това тримесечие',
    'STOCK_REPORT_TITLE_22' => 'Обобщение на проблемите по статус и по седмица на създаване',
    'STOCK_REPORT_TITLE_24' => 'Преобразувани потенциални клиенти - загубени по месец',
    'STOCK_REPORT_TITLE_25' => 'Седмични обаждания, насрочени за това тримесечие от потребителя',
    'STOCK_REPORT_TITLE_26' => 'Брой целеви клиенти по страна',
    'STOCK_REPORT_TITLE_27' => 'Седмични срещи, проведени това тримесечие от потребителя',
    'STOCK_REPORT_TITLE_28' => 'Спечелени и загубени оферти по потребител',
    'STOCK_REPORT_TITLE_29' => 'Брой дейности за поверителност на данните, създадени всеки месец по вид',
    'STOCK_REPORT_TITLE_30' => 'Обобщение на проблемите по източник и по седмица на създаване',
    'STOCK_REPORT_TITLE_31' => 'Обобщение на текущите казуси по приоритет',
    'STOCK_REPORT_TITLE_32' => 'Спешни дейности за поверителност на данните',
    'STOCK_REPORT_TITLE_33' => 'Поставени казуси по месеци за избраните потребители',
    'STOCK_REPORT_TITLE_34' => 'Нови казуси по месеци',
    'STOCK_REPORT_TITLE_35' => 'Организации по екипи за избраните потребители',
    'STOCK_REPORT_TITLE_36' => 'Потенциални клиенти в зависимост от източника',
    'STOCK_REPORT_TITLE_37' => 'Моите нови клиенти',
    'STOCK_REPORT_TITLE_38' => 'Текущи обаждания',
    'STOCK_REPORT_TITLE_39' => 'Текущи срещи',
    'STOCK_REPORT_TITLE_40' => 'Текущи задачи',
    'STOCK_REPORT_TITLE_41' => 'My Usage Metrics (Днес)',
    'STOCK_REPORT_TITLE_42' => 'My Usage Metrics (Последните 7 дни)',
    'STOCK_REPORT_TITLE_43' => 'My Usage Metrics (Последните 30 дни)',
    'STOCK_REPORT_TITLE_44' => 'Моите основни модули за работа (Днес)',
    'STOCK_REPORT_TITLE_45' => 'Моите основни модули за работа (Последните 7 дни)',
    'STOCK_REPORT_TITLE_46' => 'Моите основни модули за работа (Последните 30 дни)',
    'STOCK_REPORT_TITLE_47' => 'Users Usage Metrics (Последните 7 дни)',
    'STOCK_REPORT_TITLE_48' => 'Users Usage Metrics (Последните 30 дни)',
    'STOCK_REPORT_TITLE_49' => 'Основни модули за работа на потребители, които се отчитат на мен (Последните 30 дни)',
    'STOCK_REPORT_TITLE_50' => 'Заявки със забавяне в изпълнението',
    'STOCK_REPORT_TITLE_51' => 'Моите модифицирани записи (Последните 7 дни)',
    'STOCK_REPORT_TITLE_52' => 'Моите модифицирани записи (Последните 30 дни)',
    'STOCK_REPORT_TITLE_53' => 'Модифицирани записи на потребители, които се отчитат на мен (Последните 30 дни)',
    'STOCK_REPORT_TITLE_54' => 'Сесии на активните потребители (Последните 7 дни)',
    'STOCK_REPORT_TITLE_55' => 'User Sessions Summary (Последните 7 дни)',
    'STOCK_REPORT_TITLE_56' => 'Текущите ми казуси по приоритет',
    'STOCK_REPORT_TITLE_58' => 'Брой създадени потенциални клиенти по седмици',
    'STOCK_REPORT_TITLE_59' => 'Обобщение на проблемите по приоритетност и седмица на създаване',
    'STOCK_REPORT_TITLE_60' => 'Седмични срещи, насрочени това тримесечие от потребителя',
    'STOCK_REPORT_TITLE_61' => 'Текущите ми потенциални клиенти',
    'STOCK_REPORT_TITLE_62' => 'Създадени организации по потребител и по месец',
    'STOCK_REPORT_TITLE_63' => 'Седмични обаждания, направени за това тримесечие от потребителя',
    'STOCK_REPORT_TITLE_64' => 'Обобщение на казусите по статус и по седмица на създаване',
    'STOCK_REPORT_TITLE_65' => 'Създадени потенциални клиенти по потребители на месец',
    'STOCK_REPORT_TITLE_66' => 'Текущи дейности по поверителност на данните по вид',
    'STOCK_REPORT_TITLE_67' => 'Списък на контакти без дадено съгласие',
    'STOCK_REPORT_TITLE_68' => 'Списък на лицензираните потребители',
    'STOCK_REPORT_TITLE_69' => 'Казуси без обаждания, срещи, задачи или електронни писма',
    'STOCK_REPORT_TITLE_70' => 'Създадени контакти по потребител и по месец',
    'STOCK_REPORT_TITLE_71' => 'Създадени оферти по потребители и по месец',
    'STOCK_REPORT_TITLE_72' => 'Списък на текущите дейности по поверителност на данните',
    'STOCK_REPORT_TITLE_73' => 'Потенциални клиенти без обаждания, срещи, задачи или електронни писма',
    'STOCK_REPORT_TITLE_74' => 'Обобщение на казусите по приоритетност и седмица на създаване',
    'STOCK_REPORT_TITLE_76' => 'Спечелени и загубени оферти по месец',
    'STOCK_REPORT_TITLE_77' => 'Текущи проблеми по потребител и по приоритетност',
    'STOCK_REPORT_TITLE_78' => 'Текущи оферти по достигнат етап',
    'STOCK_REPORT_TITLE_79' => 'Брой създадени оферти по потребители и по месец',
    'STOCK_REPORT_TITLE_80' => 'Моите клиенти по район',
    'STOCK_REPORT_TITLE_81' => 'Задачи с изтичащ срок през седмицата',
    'STOCK_REPORT_TITLE_82' => 'Потенциални клиенти, преобразувани от потребителя',
    'STOCK_REPORT_TITLE_83' => 'Насрочени предстоящи срещи по профил',
    'STOCK_REPORT_TITLE_84' => 'Обобщение на казусите по източник и по седмица на създаване',
    'STOCK_REPORT_TITLE_85' => 'Списък на блокираните електронни писма',
    'STOCK_REPORT_TITLE_86' => 'Списък на възложените ми текущи дейности по поверителност на данните',
    'STOCK_REPORT_TITLE_88' => 'Списък на разрешените електронни писма',
    'STOCK_REPORT_TITLE_90' => 'Текущи оферти по етап на офертата за отделните потребители',
    'STOCK_REPORT_TITLE_91' => 'Текущите ми задачи по приоритетност и статус',
    'STOCK_REPORT_TITLE_92' => 'Брой контакти по страна',
    'STOCK_REPORT_TITLE_93' => 'Списък на екипите и лицензираните потребители',
    'STOCK_REPORT_TITLE_94' => 'Наскоро реализирани оферти',
    'STOCK_REPORT_TITLE_95' => 'Текущи проблеми по потребител и по статус',
    'STOCK_REPORT_TITLE_96' => 'Създадени потенциални клиенти по източник на месец',
    // Stock reports titles - ent
    'STOCK_REPORT_TITLE_97_ENT' => 'Най-касовите продукти тази година',
    'STOCK_REPORT_TITLE_98_ENT' => 'Моите текущи възможности във вид на фуния (приходни позиции)',
    'STOCK_REPORT_TITLE_99_ENT' => 'Възможности без обаждания, срещи, задачи или електронни писма',
    'STOCK_REPORT_TITLE_100_ENT' => 'Най-добрите търговски представители за тримесечието',
    'STOCK_REPORT_TITLE_101_ENT' => 'Текущи възможности във вид на фуния (приходни позиции)',
    'STOCK_REPORT_TITLE_102_ENT' => 'Общ брой на продажбите по тримесечие',
    'STOCK_REPORT_TITLE_103_ENT' => 'Текущи възможности и брой срещи',
    'STOCK_REPORT_TITLE_104_ENT' => 'Текущи възможности по потребител (приходни позиции)',
    'STOCK_REPORT_TITLE_105_ENT' => 'Общ брой на продажбите по тримесечие и потребител',
    'STOCK_REPORT_TITLE_106_ENT' => 'Текущи възможности по потребител и предполагаем месец на затваряне',
    'STOCK_REPORT_TITLE_107_ENT' => 'Брой създадени възможности по потребители и по месец',
    'STOCK_REPORT_TITLE_108_ENT' => 'Моите текущи възможности',
    'STOCK_REPORT_TITLE_109_ENT' => 'Брой създадени възможности по екипи и по месец',
    'STOCK_REPORT_TITLE_110_ENT' => 'Текущи възможности в зависимост от категорията по екип',
    'STOCK_REPORT_TITLE_111_ENT' => 'Текущи възможности по екип за избраните потребители',
    'STOCK_REPORT_TITLE_114_ENT' => 'Всички текущи възможности',
    'STOCK_REPORT_TITLE_115_ENT' => 'Всички реализирани възможности',
    'STOCK_REPORT_TITLE_116_ENT' => 'Реализирани приходни позиции по категории това тримесечие',
    'STOCK_REPORT_TITLE_117_ENT' => 'Текущи възможности по предполагаем месец на реализиране',
    'STOCK_REPORT_TITLE_119_ENT' => 'Приходни позиции по вид продукт',
    'STOCK_REPORT_TITLE_120_ENT' => 'Спечелени и загубени сделки по потребители за тримесечието',
    'STOCK_REPORT_TITLE_121_ENT' => 'Текущи възможности и брой обаждания',
    'STOCK_REPORT_TITLE_122_ENT' => 'Продажби за тримесечието според източника',
    'STOCK_REPORT_TITLE_123_ENT' => 'Текущи възможности по категории и предполагаем месец на затваряне',
    'STOCK_REPORT_TITLE_124_ENT' => 'Създадени възможности според източника по месеци',
	...
	'LBL_FILTERS_HELP_DESC'=>"<b>Задаване на критерии за филтриране:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b>, за който да се дефинират критерии за филтриране. По подразбиране е избран основният модул за справката (най-горе в структурата с модули). <br/><br/>За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b>.<br/><br/>2) За добавяне на нови филтри, изберете поле от списъка с полетата в секция <b>Налични полета</b>. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/>Можете да избирате произволен брой полета за филтриране от повече от един модул, представени в секцията <b>Свързани модули</b>.<br/><br/>3) Изберете <b>И</b> или <b>ИЛИ</b> съответно за включване на всички или само на избрани филтри за търсене на резултатите за справката.<br/><br/>4) [Optional] За вмъкване на нови групи с филтри, натиснете <b>Добавяне на група за филтриране</b>. Броят на групите за филтриране, както и на филтрите в отделните групи е неограничен.<br/><br/>5) [Optional] Изберете опцията Run-time за предоставяне на възможност на потребителите да използват филтъра за персонализиране на резултатите при преглед на справката.",
	'LBL_GROUP_BY_HELP_DESC'=>"<b>Определяне на колони за групиране:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b>, за който да се групират записите в справката. По подразбиране е избран основният модул за справката (най-горе в структурата с модули). <br/><br/>За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b>.<br/><br/> 2) Изберете поле от секция <b>Налични полета</b>, с което да се групират записите в справката. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/> Можете да избирате произволен брой полета за групиране от повече от един модул, представени в секцията <b>Свързани модули</b>. Избирането на голям брой условия за групиране, може да доведе до проблеми при разчитането на справката.<br/><br/> За промяна на поредността на полетата, преместете полето с влачене до желаната позиция.  Промени в подредбата се отразяват върху начина за визуализиране на резултатите.<br/><br/> Matrix справката може да съдържа не повече от 3 условия за групиране.",
	'LBL_DISPLAY_COLS_HELP_DESC'=>"<b>Избиране на колони за показване:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b>, за който да се визуализират данни в справката. По подразбиране е избран основният модул, посочен при изпълнение на стъпка &#39; Изберете модул&#39;.<br/><br/> За избиране на полета от свързан модул, натиснете върху заглавието на модула. Имате възможност за избиране и на допълнителни модули, асоциирани със свързани модули. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b>.<br/><br/> 2) Изберете поле от секция <b>Налични полета</b> за визуализиране на информация от записите в системата, въведена в полето. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/> Можете да избирате произволен брой допълнителни полета от повече от един модул, представени в секцията <b>Свързани модули</b>. Броят на полетата в справката е неограничен. Избирането на голям брой полета може да доведе до по-бавно изпълнение и евентуални проблеми при разчитането на справката.<br/><br/><br />	За промяна на поредността на полетата, преместете полето с влачене до желаната позиция. Промени в подредбата се отразяват върху поредността на колоните при визуализиране на резултатите." ,
    'LBL_DISPLAY_SUMMARY_HELP_DESC'=>"<b>Стъпки за избор на Обобщение на визуализациите:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b>, който искате да използвате за обобщенията в справката. По подразбиране е избран основният модул за справката (най-горе в структурата с модули). <br/><br/>За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b>.<br/><br/> 2) Изберете поле от секция <b>Налични полета</b>, за да изберете обобщения за справката. За търсене въведете заглавие на полето във формата за търсене.<br/><br/> След като изберете произволен брой полета за групиране от повече от един модул, представени в секцията <b>Свързани модули</b>, можете да изберете друг модул, от който можете да изберете допълнителни полета за обобщенията в справката.<br/><br/> За Матрични справки можете да изберете повече от едно поле, за да бъдат показани няколко стойности в една клетка във вашата справка." ,
	...
	'LBL_EDIT' => 'Редактирай' /*for 508 compliance fix*/,
	'LBL_SHOW' => 'Покажи' /*for 508 compliance fix*/,
	'LBL_MORE' => 'още' /*for 508 compliance fix*/,
	'LBL_LEFT' => 'Наляво' /*for 508 compliance fix*/,
	'LBL_RIGHT' => 'Надясно' /*for 508 compliance fix*/,
	'LBL_DOWN' => 'Надолу' /*for 508 compliance fix*/,
	'LBL_UP' => 'Нагоре' /*for 508 compliance fix*/,
    'LBL_ALT_INFORMATION' => 'Информация',
    'LBL_REPORT_GRAND_TOTAL' => "Общо",
    'LBL_EDIT_REPORT_BUTTON' => 'Редактиране на справка',
    'LBL_SCHEDULE_REPORT_BUTTON' => 'Създаване на график',
    'LBL_VIEW_SCHEDULES_BUTTON' => 'Преглеждане на графиците',
    ...
    'LBL_FILTER_WITH_CHARTS' => 'С графики',
    'LBL_FILTER_STOCK_REPORTS' => 'Справки за складовата наличност',
    'LBL_FILTER_NON_STOCK_REPORTS' => 'Справки за неналичните стоки',

    'ERROR_RETRIEVING_DRILLTHRU_DATA' => 'Грешка при извличане на данни от Отчета за препращане. Свържете се със създателя на отчета за съдействие.',
    'LBL_CHART_NO_DRILLTHRU' => 'Препращане не е налично',

    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Списъкът на докладите показва доклади, до които потребителят има права за достъп и същевременно отговарят на зададените критерии за търсене. Основни полета за всеки доклад се визуализират в отделните колони на списъка и в прегледа. Можете да настроите етикети за доклади и да създадете филтри. Чрез натискане с мишката върху името на даден доклад можете да видите доклада или да промените доклада чрез избиране на "Редактирай доклада" в менюто на действията.',
  );
