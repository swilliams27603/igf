...
$mod_strings = array (
  ...
  'LNK_ADVANCED_REPORTING' => 'Управление расширенными отчетами',
    'LNK_REPORT_SCHEDULES' => 'Расписания отчетов',
  'LBL_REPORTS' => 'Отчеты',
  'LBL_TITLE' => 'Название',
...
// report_name
  ...
  'LBL_GROUP_BY_REQUIRED'=>'По крайней мере один параметр группировки и один столбец итогов требуются для создания диаграммы.',
    ...
    'LBL_NO_VIEW_PERMISSIONS' => 'У вас нет прав на просмотр этого отчета.',
	'LBL_NONE' => 'Нет',
	'LBL_NONE_STRING' => 'Нет',
    ...
    'LBL_SUBJECT_SCHEDULED_REPORT' => 'Запланированный отчет: ',
    'LBL_SUBJECT_AS_OF' => ' по состоянию на ',
	'LBL_HELLO' => 'Здравствуйте',
    'LBL_SCHEDULED_REPORT_MSG_INTRO' => 'В приложении находится автоматически сгенерированный отчет, запланированный для вас.',
    'LBL_SCHEDULED_REPORT_MSG_BODY1' => 'Название отчета: ',
    'LBL_SCHEDULED_REPORT_MSG_BODY2' => 'Дата и время выполнения отчета: ',
    ...
    'LBL_REPORT_SCHEDULE_TITLE' => 'Новое расписание',
    'LBL_VIEW_SCHEDULES_TITLE' => 'Просмотр расписаний',
    ...
    'STOCK_REPORT_TITLE_1' => 'Количество открытых задач по пользователям по неделе',
    'STOCK_REPORT_TITLE_2' => 'Контрагенты по назначению пользователю',
    'STOCK_REPORT_TITLE_3' => 'Мои открытые ошибки по приоритету',
    'STOCK_REPORT_TITLE_5' => 'Открытые обращения по пользователям и приоритету',
    'STOCK_REPORT_TITLE_6' => 'Список предварительных контактов без согласия',
    'STOCK_REPORT_TITLE_7' => 'Открытые коммерческие предложения по стадии и закрытому месяцу',
    'STOCK_REPORT_TITLE_8' => 'Созданные ошибки по месяцам и приоритету',
    'STOCK_REPORT_TITLE_9' => 'Действие для защиты данных, завершенное и отклоненное в каждом месяце',
    'STOCK_REPORT_TITLE_10' => 'Недавно созданное действие для защиты данных',
    'STOCK_REPORT_TITLE_11' => 'Открытые коммерческие предложения, срок действия которых истекает в этом месяце',
    'STOCK_REPORT_TITLE_12' => 'Открытые обращения по пользователям и статусу',
    'STOCK_REPORT_TITLE_13' => 'Ошибки по категории продуктов и статусу',
    'STOCK_REPORT_TITLE_14' => 'Количество предварительных контактов (неконвертируемых) по странам',
    'STOCK_REPORT_TITLE_15' => 'Будущие звонки, запланированные контрагентом',
    'STOCK_REPORT_TITLE_17' => 'Действие для защиты данных просрочено',
    'STOCK_REPORT_TITLE_18' => 'Открытые предварительные контакты по пользователям',
    'STOCK_REPORT_TITLE_19' => 'Созданные ошибки по месяцу и категории',
    'STOCK_REPORT_TITLE_21' => 'Задания, выполненные пользователями, по неделям этого квартала',
    'STOCK_REPORT_TITLE_22' => 'Сводка ошибок по статусу и неделе создания',
    'STOCK_REPORT_TITLE_24' => 'Конвертированные/потерянные предварительные контакты по месяцам',
    'STOCK_REPORT_TITLE_25' => 'Еженедельные звонки, запланированные в этом квартале, по пользователям',
    'STOCK_REPORT_TITLE_26' => 'Количество потенциальных клиентов по странам',
    'STOCK_REPORT_TITLE_27' => 'Еженедельные собрания, проведенные в этом квартале, по пользователям',
    'STOCK_REPORT_TITLE_28' => 'Выигранные/проигранные коммерческие предложения по пользователям',
    'STOCK_REPORT_TITLE_29' => 'Количество действий для защиты данных, совершенных каждый месяц, по типу',
    'STOCK_REPORT_TITLE_30' => 'Сводка ошибок по источнику и неделе создания',
    'STOCK_REPORT_TITLE_31' => 'Сводка открытых обращений по приоритету',
    'STOCK_REPORT_TITLE_32' => 'Срочное действие для защиты данных',
    'STOCK_REPORT_TITLE_33' => 'Открытые обращения по месяцам и пользователям',
    'STOCK_REPORT_TITLE_34' => 'Новые обращения по месяцам',
    'STOCK_REPORT_TITLE_35' => 'Контрагенты по типу и отрасли',
    'STOCK_REPORT_TITLE_36' => 'Предварительные контакты по источнику предварительного контакта',
    'STOCK_REPORT_TITLE_37' => 'Мои новые учётные записи клиентов',
    'STOCK_REPORT_TITLE_38' => 'Открытые звонки',
    'STOCK_REPORT_TITLE_39' => 'Открытые встречи',
    'STOCK_REPORT_TITLE_40' => 'Открытые задачи',
    'STOCK_REPORT_TITLE_41' => 'Мои показатели использования (сегодня)',
    'STOCK_REPORT_TITLE_42' => 'Мои показатели использования (последние 7 дней)',
    'STOCK_REPORT_TITLE_43' => 'Мои показатели использования (последние 30 дней)',
    'STOCK_REPORT_TITLE_44' => 'Моё использование модулей (сегодня)',
    'STOCK_REPORT_TITLE_45' => 'Моё использование модулей (последние 7 дней)',
    'STOCK_REPORT_TITLE_46' => 'Моё использование модулей (последние 30 дней)',
    'STOCK_REPORT_TITLE_47' => 'Показатели использования пользователями (последние 7 дней)',
    'STOCK_REPORT_TITLE_48' => 'Показатели использования пользователями (последние 30 дней)',
    'STOCK_REPORT_TITLE_49' => 'Модули, использованные в моих прямых отчётах (последние 30 дней)',
    'STOCK_REPORT_TITLE_50' => 'Медленные запросы',
    'STOCK_REPORT_TITLE_51' => 'Мои изменённые записи (последние 7 дней)',
    'STOCK_REPORT_TITLE_52' => 'Мои недавно изменённые записи (последние 30 дней)',
    'STOCK_REPORT_TITLE_53' => 'Записи, изменённые моими прямыми отчётами (последние 30 дней)',
    'STOCK_REPORT_TITLE_54' => 'Активные сессии пользователя (последние 7 дней)',
    'STOCK_REPORT_TITLE_55' => 'Итог сессий пользователя (последние 7 дней)',
    'STOCK_REPORT_TITLE_56' => 'Мои открытые обращения по приоритету',
    'STOCK_REPORT_TITLE_58' => 'Количество созданных предварительных контактов по неделям',
    'STOCK_REPORT_TITLE_59' => 'Сводка ошибок по приоритету и неделе создания',
    'STOCK_REPORT_TITLE_60' => 'Еженедельные собрания, запланированные в этом квартале, по пользователям',
    'STOCK_REPORT_TITLE_61' => 'Мои открытые предварительные контакты',
    'STOCK_REPORT_TITLE_62' => 'Созданные контрагенты по пользователям и месяцам',
    'STOCK_REPORT_TITLE_63' => 'Еженедельные звонки, сделанные в этом квартале, по пользователям',
    'STOCK_REPORT_TITLE_64' => 'Сводка обращений по статусу и неделе создания',
    'STOCK_REPORT_TITLE_65' => 'Предварительные контакты, созданные пользователем за месяц',
    'STOCK_REPORT_TITLE_66' => 'Открытые действия для защиты данных по типу',
    'STOCK_REPORT_TITLE_67' => 'Список контактов без согласия',
    'STOCK_REPORT_TITLE_68' => 'Список лицензированных пользователей',
    'STOCK_REPORT_TITLE_69' => 'Обращения без звонков, встреч, заданий или сообщений электронной почты',
    'STOCK_REPORT_TITLE_70' => 'Контакты, созданные пользователем, по месяцам',
    'STOCK_REPORT_TITLE_71' => 'Коммерческие предложения, созданные пользователями, по месяцам',
    'STOCK_REPORT_TITLE_72' => 'Список открытых действий для защиты данных',
    'STOCK_REPORT_TITLE_73' => 'Предварительные контакты без звонков, встреч, заданий или сообщений электронной почты',
    'STOCK_REPORT_TITLE_74' => 'Сводка обращений по приоритету и неделе создания',
    'STOCK_REPORT_TITLE_76' => 'Выигранные/проигранные коммерческие предложения по месяцам',
    'STOCK_REPORT_TITLE_77' => 'Открытые ошибки по пользователям и приоритету',
    'STOCK_REPORT_TITLE_78' => 'Открытые коммерческие предложения по стадии',
    'STOCK_REPORT_TITLE_79' => 'Количество созданных пользователями коммерческих предложений по месяцам',
    'STOCK_REPORT_TITLE_80' => 'Мои клиенты по областям',
    'STOCK_REPORT_TITLE_81' => 'Задачи на эту неделю',
    'STOCK_REPORT_TITLE_82' => 'Предварительные контакты, преобразованные пользователем в реальные',
    'STOCK_REPORT_TITLE_83' => 'Будущие встречи, запланированные контрагентом',
    'STOCK_REPORT_TITLE_84' => 'Сводка обращений по источнику и неделе создания',
    'STOCK_REPORT_TITLE_85' => 'Список адресов электронной почты, отписавшихся от рассылки',
    'STOCK_REPORT_TITLE_86' => 'Список закрепленных за мной открытых действий для защиты данных',
    'STOCK_REPORT_TITLE_88' => 'Список адресов электронной почты, подписавшихся на рассылку',
    'STOCK_REPORT_TITLE_90' => 'Открытые коммерческие предложения по стадии и пользователям',
    'STOCK_REPORT_TITLE_91' => 'Мои открытые задачи по приоритету и статусу',
    'STOCK_REPORT_TITLE_92' => 'Количество контактов по странам',
    'STOCK_REPORT_TITLE_93' => 'Список команд и лицензированных пользователей',
    'STOCK_REPORT_TITLE_94' => 'Недавно закрытые коммерческие предложения',
    'STOCK_REPORT_TITLE_95' => 'Открытые ошибки по пользователям и статусу',
    'STOCK_REPORT_TITLE_96' => 'Предварительные контакты по источнику за месяц',
    // Stock reports titles - ent
    'STOCK_REPORT_TITLE_97_ENT' => 'Главные валовые продукты этого года',
    'STOCK_REPORT_TITLE_98_ENT' => 'Моя воронка продаж (доход по продуктам)',
    'STOCK_REPORT_TITLE_99_ENT' => 'Сделки без звонков, встреч, заданий или сообщений электронной почты',
    'STOCK_REPORT_TITLE_100_ENT' => 'Лучшие специалисты по работе с клиентами за этот квартал',
    'STOCK_REPORT_TITLE_101_ENT' => 'Воронка продаж (доход по продуктам)',
    'STOCK_REPORT_TITLE_102_ENT' => 'Все сделки по кварталам',
    'STOCK_REPORT_TITLE_103_ENT' => 'Открытые сделки и количество встреч',
    'STOCK_REPORT_TITLE_104_ENT' => 'Воронка по пользователям (доход по продуктам)',
    'STOCK_REPORT_TITLE_105_ENT' => 'Все сделки по кварталам и пользователям',
    'STOCK_REPORT_TITLE_106_ENT' => 'Открытые сделки по пользователям и прогнозированному закрытому месяцу',
    'STOCK_REPORT_TITLE_107_ENT' => 'Количество сделок, созданных пользователем, по месяцам',
    'STOCK_REPORT_TITLE_108_ENT' => 'Мои открытые сделки',
    'STOCK_REPORT_TITLE_109_ENT' => 'Количество сделок, созданных командой, по месяцам',
    'STOCK_REPORT_TITLE_110_ENT' => 'Воронка продаж по типу и команде',
    'STOCK_REPORT_TITLE_111_ENT' => 'Воронка продаж по команде и пользователям',
    'STOCK_REPORT_TITLE_114_ENT' => 'Все открытые сделки',
    'STOCK_REPORT_TITLE_115_ENT' => 'Все закрытые сделки',
    'STOCK_REPORT_TITLE_116_ENT' => 'Полученный доход по продуктам в этом квартале по типу',
    'STOCK_REPORT_TITLE_117_ENT' => 'Открытые сделки по прогнозированному закрытому месяцу',
    'STOCK_REPORT_TITLE_119_ENT' => 'Доход по продуктам по продукту',
    'STOCK_REPORT_TITLE_120_ENT' => 'Выигранные и проигранные сделки в этом квартале по пользователям',
    'STOCK_REPORT_TITLE_121_ENT' => 'Открытые сделки и количество звонков',
    'STOCK_REPORT_TITLE_122_ENT' => 'Продажи за квартал по источнику предварительного контакта',
    'STOCK_REPORT_TITLE_123_ENT' => 'Открытые сделки по типу и прогнозированному закрытому месяцу',
    'STOCK_REPORT_TITLE_124_ENT' => 'Созданные сделки по источнику предварительного контакта и месяцам',
    ...
    'LBL_SCHEDULE_REPORT_BUTTON' => 'Новое расписание',
    'LBL_VIEW_SCHEDULES_BUTTON' => 'Просмотр расписаний',
    ...
    'LBL_FILTER_STOCK_REPORTS' => 'Отчеты о наличных запасах',
    'LBL_FILTER_NON_STOCK_REPORTS' => 'Отчеты о позициях вне запаса',
